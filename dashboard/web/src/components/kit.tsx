...
export const btnSmallPrimary =
  "inline-flex h-8 items-center gap-1.5 rounded bg-brand-500 px-2.5 text-theme-xs font-medium text-gray-950 hover:bg-brand-400 disabled:opacity-40";
...
/** Etykieta z checkboxem w środku – obramowanie w akcencie, gdy zaznaczona. */
export const checkChip =
  "inline-flex h-8 cursor-pointer items-center gap-2 rounded border border-gray-300 px-3 text-theme-xs font-medium text-gray-600 select-none hover:text-gray-800 has-checked:border-brand-500 has-checked:bg-brand-50 has-checked:text-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white/90 dark:has-checked:bg-brand-500/15 dark:has-checked:text-white/90";
...
/** Komunikat „pracuję…” z kręcącym się znacznikiem. */
