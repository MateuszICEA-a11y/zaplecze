...
level: 'L1'
sources:
  - title: 'Inteligentny agent'
    url: 'https://pl.wikipedia.org/wiki/Inteligentny_agent'
    note: 'Wikipedia. Definicja agenta jako jednostki, która postrzega otoczenie i podejmuje autonomiczne działania w celu osiągnięcia celów.'
  - title: 'Introducing the Model Context Protocol'
    url: 'https://www.anthropic.com/news/model-context-protocol'
    note: 'Anthropic, 25 listopada 2024. Ogłoszenie i udostępnienie jako open source protokołu MCP.'
  - title: 'Donating the Model Context Protocol and establishing the Agentic AI Foundation'
    ...
    note: 'Anthropic, 9 grudnia 2025. Przekazanie MCP do Agentic AI Foundation działającej w strukturach Linux Foundation.'
  - title: 'Architecture overview'
    url: 'https://modelcontextprotocol.io/docs/learn/architecture'
    note: 'Dokumentacja MCP. Role hosta, klienta i serwera oraz prymitywy serwera: narzędzia, zasoby i prompty.'
  - title: 'MCP Security Notification: Tool Poisoning Attacks'
    url: 'https://invariantlabs.ai/blog/mcp-security-notification-tool-poisoning-attacks'
    note: 'Invariant Labs, 1 kwietnia 2025. Opis ataku tool poisoning i scenariusza, w którym serwer zmienia opis narzędzia po jego zatwierdzeniu.'
