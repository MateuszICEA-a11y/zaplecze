...
sources:
  - title: 'Lost in the Middle: How Language Models Use Long Contexts'
    ...
    note: 'Liu i in., lipiec 2023. Modele najlepiej wykorzystują informacje z początku i końca kontekstu, gorzej – ze środka.'
  - title: 'ColBERT: Efficient and Effective Passage Search via Contextualized Late Interaction over BERT'
    url: 'https://arxiv.org/abs/2004.12832'
    note: 'Khattab, Zaharia, kwiecień 2020. Pierwotny opis późnej interakcji z reprezentacjami dokumentów liczonymi offline.'
  - title: 'PLAID: An Efficient Engine for Late Interaction Retrieval'
    url: 'https://arxiv.org/abs/2205.09707'
    note: 'Maj 2022. Silnik przyspieszający ColBERTv2 do opóźnień rzędu dziesiątek milisekund na GPU.'
  ...
  - title: 'FlashRank'
    ...
    note: 'Repozytorium open source (Apache 2.0). Ultralekka biblioteka rerankingu działająca na CPU.'
  - title: 'jinaai/jina-reranker-v3'
...
Klasyczne [RAG](/rag/przewodnik/) opiera wyszukiwanie na bi-encoderach. System zamienia każdy fragment tekstu na jeden wektor liczbowy (embedding), a w momencie zapytania szuka wektorów najbardziej zbliżonych do wektora zapytania. To podejście gwarantuje szybkość i skalowalność. Miliony fragmentów przeszukasz w milisekundy.
...
Jeśli chcesz zobaczyć, jak silniki AI postrzegają cytowania generowane przez Twój system RAG, [Widoczność marki w AI](/narzedzia/brand-check/) pokaże aktualną obecność Twojej marki w odpowiedziach czterech głównych modeli. Warto traktować to jako zewnętrzny punkt odniesienia dla jakości Twojego systemu.
...
Jak LLM-y korzystają ze źródeł i jak to wpływa na jakość cytowań, wyjaśnia artykuł o [tym, jak LLM-y cytują źródła](/geo/jak-llm-cytuja-zrodla/). To świetna, uzupełniająca perspektywa na całą warstwę między Twoją bazą wiedzy a finalną odpowiedzią.
