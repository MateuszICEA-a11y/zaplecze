...
sources:
  - title: 'Vendor lock-in'
    ...
    note: 'Wikipedia. Definicja uzależnienia od dostawcy i kosztów zmiany.'
  - title: 'Nearly 3 in 4 enterprises say losing AI vendors would disrupt core business operations'
    url: 'https://zapier.com/blog/ai-vendor-lock-in-survey/'
    note: 'Zapier, 2026. Badanie: 74% firm odczułoby utratę dostawcy AI, 6% zmieniłoby go bez zakłóceń, 58% nieudanych lub trudnych migracji, 46% wskazuje migrację danych, 44% korzysta z kilku dostawców.'
  - title: 'Key SaaS inflation stats: How to mitigate in 2025'
    url: 'https://www.vertice.one/blog/mitigating-2025-saas-inflation-stats'
    note: 'Vertice, 28 stycznia 2025. Ceny SaaS wzrosły o 11,4% rok do roku przy średniej inflacji 2,7% w krajach G7.'
  - title: 'Salesforce Introduces New Flexible Agentforce Pricing to Accelerate the Digital Labor Revolution'
    url: 'https://www.salesforce.com/news/press-releases/2025/05/15/agentforce-flexible-pricing-news/'
    note: 'Salesforce, 15 maja 2025. Potwierdza model rozliczenia Agentforce 2 dolary za konwersację i wprowadzenie Flex Credits.'
  - title: 'AI cost overruns are adding up – with major implications for CIOs'
    ...
    note: 'CIO, 2 października 2025. Badanie Benchmarkit i Mavvrik: 85% firm myli się w szacunku kosztów AI o ponad 10%, blisko co czwarta o 50% i więcej.'
