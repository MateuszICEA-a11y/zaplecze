...
sources:
  - title: 'Annex III: High-Risk AI Systems Referred to in Article 6(2)'
    ...
    note: 'EU Artificial Intelligence Act (tekst rozporządzenia UE 2024/1689). Punkt 4 zalicza AI w rekrutacji, selekcji i zarządzaniu pracownikami do systemów wysokiego ryzyka.'
  - title: 'Gartner Survey Shows 88% of HR Leaders Say Their Organizations Have Not Realized Significant Business Value from AI Tools'
    url: 'https://www.gartner.com/en/newsroom/press-releases/2025-10-28-gartner-survey-shows-88-percent-of-hr-leaders-say-their-organizations-have-not-realized-significant-business-value-from-ai-tools'
    note: 'Gartner, 28 października 2025. Ankieta 114 liderów HR z lipca 2025: 88% organizacji nie osiągnęło znaczących korzyści biznesowych z AI.'
  - title: 'Amazon Scraps Secret AI Recruiting Tool that Showed Bias Against Women'
    url: 'https://mediawell.ssrc.org/news-items/amazon-scraps-secret-ai-recruiting-tool-that-showed-bias-against-women-reuters/'
    note: 'Reuters (Jeffrey Dastin), 2018, omówienie w MediaWell/SSRC. Algorytm Amazona obniżał oceny CV zawierających słowo „women’s”, bo uczył się głównie na życiorysach mężczyzn.'
  - title: 'Federal Court Allows Collective Action Lawsuit Over Alleged AI Hiring Bias'
    url: 'https://www.hklaw.com/en/insights/publications/2025/05/federal-court-allows-collective-action-lawsuit-over-alleged'
    note: 'Holland & Knight, 27 maja 2025. Sprawa Mobley v. Workday z 2023 roku i wstępna certyfikacja powództwa zbiorowego w maju 2025.'
  - title: 'Art. 22 GDPR – Automated individual decision-making, including profiling'
    url: 'https://gdpr-info.eu/art-22-gdpr/'
    note: 'Tekst RODO (rozporządzenie UE 2016/679). Prawo do niepodlegania decyzji opartej wyłącznie na zautomatyzowanym przetwarzaniu i gwarancja interwencji człowieka.'
  - title: 'AI Omnibus enters into force'
    url: 'https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force'
    note: 'Komisja Europejska, 27 lipca 2026. Przepisy dla systemów wysokiego ryzyka z Załącznika III stosuje się od 2 grudnia 2027 roku.'
  - title: 'Article 5: Prohibited AI Practices'
    url: 'https://artificialintelligenceact.eu/article/5/'
    note: 'EU Artificial Intelligence Act. Art. 5 ust. 1 lit. f zakazuje wnioskowania o emocjach w miejscu pracy i w edukacji.'
  - title: 'Article 99: Penalties'
    url: 'https://artificialintelligenceact.eu/article/99/'
    note: 'EU Artificial Intelligence Act. Kary do 35 mln euro lub 7% obrotu za praktyki zakazane i do 15 mln euro lub 3% za naruszenie pozostałych obowiązków.'
---
