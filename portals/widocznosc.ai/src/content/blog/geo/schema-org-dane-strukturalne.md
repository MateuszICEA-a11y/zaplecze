...
sources:
  - title: 'Schema Markup’s Real Impact on AI Search | OtterlyAI Experiment'
    ...
    note: 'Otterly.ai, aktualizacja 23 marca 2026. Eksperyment 7.12.2025–7.03.2026 na stronie otterly.ai: +377% funkcji SERP, +1500% AI Overviews; 6 z 7 platform AI nie odczytało JSON-LD, poprawnie zrobił to tylko Gemini.'
  ...
  - title: 'Overview of OpenAI Crawlers'
    ...
    note: 'OpenAI. OAI-SearchBot służy do pokazywania stron w wynikach wyszukiwania ChatGPT.'
