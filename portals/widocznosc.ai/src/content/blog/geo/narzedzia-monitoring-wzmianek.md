...
sources:
  - title: 'Duży model językowy'
    ...
    note: 'Wikipedia. Definicja dużego modelu językowego (LLM).'
  - title: 'AI Visibility Toolkit Pricing | Semrush'
    url: 'https://www.semrush.com/pricing/ai/'
    note: 'Semrush. AI Visibility Toolkit za 99 USD miesięcznie za domenę, śledzenie promptów i analiza konkurencji.'
  ...
  - title: 'The easiest all-in-one AI SEO tool'
    url: 'https://www.riffanalytics.ai/'
    note: 'Riff Analytics. Monitoring widoczności w silnikach AI i analiza luk w cytowaniach; plany Starter 49 USD i Pro 199 USD.'
  - title: 'AI Search Watcher: Accurate & Affordable LLM Rank Tracker'
    url: 'https://mangools.com/ai-search-watcher'
    note: 'Mangools. Lista śledzonych modeli i wielokrotne uruchamianie każdego promptu dla stabilniejszych wyników.'
