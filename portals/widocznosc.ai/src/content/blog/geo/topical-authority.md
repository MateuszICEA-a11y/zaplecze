...
<aside class="callout-fact">
  ...
  <div class="callout-body">
    ...
    <p>Pillar + cluster to nie wymysł ery LLM. Architekturę wprowadził <strong>HubSpot w 2017 roku</strong> jako odpowiedź na semantyczne grupowanie wyników w klasycznym Google. Brian Halligan i Mark Roberge pokazali, że strony zorganizowane w pillar-cluster osiągają pozycje dla 4× więcej fraz długiego ogona niż strony zorganizowane chronologicznie po dacie publikacji. Dziewięć lat później ten sam mechanizm działa w warstwie retrieval LLM-ów – tyle że stawka jest dużo wyższa.</p>
  </div>
</aside>
...
Architektura pillar + cluster nie jest wymysłem ery GEO. Powstała w 2017 roku w HubSpot, oparta o badania Briana Halligana i Marka Roberge, jako odpowiedź na rosnący nacisk Google na semantyczną grupowość treści. Działa od dawna w klasycznym SEO, ale w erze LLM jej wartość rośnie nieproporcjonalnie.
...
3. **Z 30 podzapytań wybierz 12–18**, które poruszają różne aspekty (intent, format, faza decyzji)
...
| Reguła | Co | Dlaczego |
|---|---|---|
| **Cluster → Pillar (min. 2×)** | każdy cluster linkuje do pillara minimum 2 razy: w intro (kontekst nadrzędny) + w zakończeniu (CTA do pełnego przewodnika) | buduje graf topologiczny z wyraźnym hubem |
...
- **Pojawia się w fragmencie, który sam ma sens** – LLM często wybiera fragment 3-5 zdań wokół linka jako fragment reprezentujący linkowaną stronę
...
2. **Tygodnie 3–4: wybór 1 pillara do prototypu** – nie próbuj zbudować 5 pillarów naraz, zacznij od jednego, najbardziej komercyjnego. Wybierz 8–12 cluster pages z istniejącej bazy lub zaplanuj te do dopisania
...
4. **Tygodnie 9–12: interlinking i monitoring** – wdrożenie pełnej macierzy linkowania wewnętrznego, [schema.org](https://pl.wikipedia.org/wiki/Schema.org) dla pillara i cluster, monitoring SoV i Citation Rate przez kolejne 4–6 tygodni
