...
Zakładkę można kliknąć przed wysłaniem promptu albo w dowolnym czacie z historii. **Panel czyta rozmowę z tego samego adresu, z którego pobiera ją aplikacja ChatGPT, a te dane zawierają treść zapytań także w zapisanych czatach.** Wyjątkiem są odpowiedzi modelu z rozumowaniem: ChatGPT zapisuje wtedy zapytania tylko dla niektórych rund, zwykle pierwszej w każdej serii wyszukiwań, a dla pozostałych same strony z wyników. Przy włączonym trybie „na żywo” panel czeka, aż ChatGPT skończy odpowiadać, i dopiero wtedy odczytuje rozmowę. Nie pobiera jej w trakcie generowania, bo zbyt częste odczyty ChatGPT blokuje błędem 429.
