...
![Query fan-out – jak działa rozszczepienie zapytania: pojedyncze pytanie użytkownika rozbija się na 4 grupy intencji (porównawcze, cenowe, techniczne, opinie) i 14 konkretnych podzapytań, każde idzie osobno do indeksu](../../../assets/images/infographic-query-fan-out.png)
