...
sources:
  - title: 'How large is the context window on paid Claude plans?'
    ...
    note: 'Claude Help Center. Okno 500 tys. tokenów w czacie dla Opus 4.8 i Sonnet 4.6 oraz 1 mln tokenów w Claude Code.'
  ...
  - title: 'Introducing Claude Sonnet 4.6'
    ...
    note: 'Anthropic, 17 lutego 2026. Wynik 79,6% w SWE-bench Verified i cena 3/15 USD za milion tokenów.'
  - title: 'Pricing'
    url: 'https://platform.claude.com/docs/en/about-claude/pricing'
    note: 'Anthropic, dokumentacja API. Cennik modeli Claude, w tym Opus 4.8 (5/25 USD) i Sonnet 4.6 (3/15 USD) za milion tokenów.'
  - title: 'Gemini Developer API pricing'
    url: 'https://ai.google.dev/gemini-api/docs/pricing'
    note: 'Google AI for Developers. Cena Gemini 3.1 Pro: 2/12 USD do 200 tys. tokenów promptu, 4/18 USD powyżej.'
