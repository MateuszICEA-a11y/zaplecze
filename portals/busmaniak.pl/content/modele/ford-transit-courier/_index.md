...
Pierwsza generacja powstała na platformie Ford Global B-car (dzielonej z Fiestą Mk6) i była produkowana w tureckich zakładach w Kocaeli. Projektanci postawili na kompaktowe wymiary zewnętrzne (4160 mm długości), które skrywały przestrzeń cargo o objętości 2,3 m³. Pod maskę trafiały jednostki [Ford EcoBoost](https://en.wikipedia.org/wiki/Ford_EcoBoost_engine) o mocy 100 KM oraz oszczędne diesle 1.5 i 1.6 TDCi. Masa własna oscylowała w granicach 1190–1310 kg, co zapewniało autu zwinność nawet przy pełnym obciążeniu. W grudniu 2017 roku pierwsza generacja przeszła modernizację: otrzymała nowy zderzak, atrapę chłodnicy i ekran 6 cali w kabinie.

### Transit Courier II (2024–dziś)
...
| Parametr | Wartość (furgon 2024/2025) |
| :--- | :--- |
| Długość całkowita | 4337 mm |
| Szerokość (bez lusterek) | 1800 mm |
| Szerokość (z lusterkami) | 2076 mm |
| Wysokość całkowita | 1827 mm |
| Rozstaw osi | 2692 mm |
| Wysokość ładowni | 1120 mm (opcja: 1262 mm) |
| Szerokość ładowni | 1535 mm |
| Szerokość między nadkolami | 1220 mm |
| Długość ładowni (do przegrody) | 1802 mm |
| Maksymalna objętość cargo | 2,91 m³ |
| Ładowność (wersja wzmocniona) | do 845 kg |
| Średnica zawracania | 10,7 m |

### Transit Courier Van

Wersja dostawcza to fundament oferty, gdzie liczy się każdy centymetr. Maksymalna długość ładunku wynosi 1802 mm, jednak dzięki opcjonalnej klapie w przegrodzie możesz przewozić przedmioty o długości przekraczającej 2,5 metra. Standardowa ładowność wynosi 680 kg, ale jeśli planujesz cięższe transporty, wybierz wariant o zwiększonej nośności do 845 kg.
...
Trzycylindrowy silnik 1.0 EcoBoost występuje w dwóch wariantach mocy: 100 KM oraz 125 KM. Mocniejsza wersja może współpracować z 7-stopniową automatyczną skrzynią dwusprzęgłową (7DCT), co podnosi komfort jazdy w korkach. Wersja ta zbiera pozytywne opinie za kulturę pracy i dynamikę – moment obrotowy wynosi 170–200 Nm, choć przy dużym obciążeniu spalanie w mieście może przekroczyć 8 litrów na 100 km.

| Wariant | Moc | Moment | Skrzynia | 0–100 km/h | Vmax | Zbiornik |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1.0 EcoBoost | 100 KM (74 kW) | 170 Nm | 6MT | 13,4–14,1 s | 157 km/h | 48 l |
| 1.0 EcoBoost | 125 KM (92 kW) | 200 Nm | 6MT / 7DCT | ok. 13 s | 170 km/h | 48 l |

### 1.5 TDCi / EcoBlue (diesel)

W nowej generacji dostępny jest silnik 1.5 EcoBlue o mocy 100 KM i momencie obrotowym 250 Nm. To jedyny wybór dla osób liczących każdy litr paliwa na autostradzie, gdzie średnie zużycie może spaść do 4,8–5,2 l/100 km. Starsze egzemplarze korzystały z jednostek 1.5 TDCi (75 KM) oraz 1.6 TDCi (95 KM), które słyną z trwałości układu korbowo-tłokowego.

{{% expert name="Kowalczyk" %}}
Diesle EcoBlue wymagają stosowania płynu AdBlue i pilnowania terminów wymiany oleju. Wymiana co 15–20 tysięcy kilometrów to absolutne maksimum, aby uniknąć problemów ze smarowaniem turbosprężarki i przedwczesnym zużyciem wałków rozrządu.
{{% /expert %}}

### E-Transit Courier (elektryczny)

Elektryczny wariant dysponuje mocą 100 kW (136 KM) i błyskawicznie dostępnym momentem 290 Nm. Akumulator ma pojemność 43 kWh netto (54 kWh brutto), co przy zasięgu WLTP do 293 km sprawdza się w dostawach miejskich bez obaw o limity stref czystego transportu. Szybkie ładowanie DC o mocy 100 kW pozwala uzupełnić energię od 10 do 80% w zaledwie 23 minuty. Ładowanie AC o mocy 11 kW trwa 5,3 godziny. Prędkość maksymalna wynosi 145 km/h.

## Ceny Forda Transit Courier

Zakup nowego modelu wiąże się z wydatkiem startującym od ok. 64 900 zł netto w ofertach promocyjnych dla przedsiębiorców. Standardowy cennik katalogowy oscyluje w granicach 81 900–92 900 zł netto za wersje spalinowe w bogatszym wyposażeniu. Sprawdź programy leasingowe, gdzie raty zaczynają się od 800–1100 zł netto przy rozsądnej wpłacie własnej.

### Nowy Transit Courier

Ceny nowych egzemplarzy zależą od wersji silnikowej i poziomu wyposażenia. Najtańsza konfiguracja (Trend z 1.0 EcoBoost 100 KM) startuje od 64 900 zł netto w promocji. Wersja Limited z dieslem EcoBlue i automatem 7DCT to wydatek rzędu 90 000–93 000 zł netto. Wariant elektryczny E-Transit Courier nie ma jeszcze oficjalnego polskiego cennika, ale na rynkach zachodnich ceny zaczynają się od ok. 30 000 euro netto.

### Używany Transit Courier

Rynek wtórny oferuje duży rozstrzał cenowy, zależny od stanu technicznego i rocznika. Egzemplarze z początku produkcji (2014–2015) z wysokimi przebiegami można kupić już za 18 000–22 000 zł brutto. Nowsze auta z lat 2024/2025, często demonstracyjne lub pokontraktowe, trzymają cenę w okolicach 85 000–105 000 zł, oferując jednak pełną gwarancję producenta.
...
- **Czujniki ciśnienia doładowania** – awarie, szczególnie w wersji 125 KM
- **Termostat** – zdarza się zawieszenie w pozycji otwartej, niedogrzewanie silnika
- **Turbina** – przy przebiegu powyżej 200 tys. km i zaniedbanych wymianach oleju

### Silnik 1.5 TDCi/EcoBlue

- **Filtr DPF** – zapychanie podczas jazdy wyłącznie miejskiej
- **Chłodniczka EGR** – wycieki, szczególnie w egzemplarzach 2014–2017
- **Wtryskiwacze** – wrażliwe na jakość paliwa, objawiają się nierówną pracą silnika
...
| :--- | :--- | :--- | :--- | :--- |
| **Ford Transit Courier** | 2,9 m³ | 845 kg | 64 900 zł | Najbardziej zwrotny, niskie spalanie |
| **Renault Kangoo** | 3,3–3,8 m³ | 800 kg | 75 000 zł | Większa paka, droższy w zakupie |
| **VW Caddy** | 3,1–3,7 m³ | 730 kg | 85 000 zł | Wysoka jakość, wysoki koszt serwisu |
