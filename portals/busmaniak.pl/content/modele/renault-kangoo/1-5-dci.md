...
lead: "Silnik 1.5 dCi to zdecydowanie najpopularniejsza jednostka napędowa w Renault Kangoo II. Sam silnik K9K o pojemności 1461 cm³ trafił do produkcji około 2001 roku, natomiast w Kangoo II był oferowany od debiutu tej generacji w 2008 roku. W zależności od rynku, rocznika i wersji nadwozia występował w kilku odmianach mocy – od słabszych wariantów użytkowych po 110-konną wersję przeznaczoną do cięższej pracy i jazdy w trasie."
faq:
  - question: "Ile pali Renault Kangoo 1.5 dCi?"
    answer: "Orientacyjnie Renault Kangoo 1.5 dCi zużywa około 5–6 l/100 km w cyklu mieszanym. W mieście zwykle jest to około 6–7,5 l/100 km, a w trasie przy spokojnej jeździe około 4,5–5,5 l/100 km. Wynik zależy od wersji silnika, długości nadwozia i obciążenia."
  - question: "Czy silnik 1.5 dCi w Kangoo jest trwały?"
    answer: "Tak, ale trwałość w dużym stopniu zależy od rocznika, kodu silnika K9K i historii serwisowej. Przy regularnych wymianach oleju, pilnowaniu rozrządu i właściwej diagnostyce używany egzemplarz może dobrze znosić wysokie przebiegi."
  - question: "Jakie są typowe usterki 1.5 dCi w Kangoo?"
    answer: "Najczęściej sprawdza się stan turbosprężarki, wtrysku, EGR oraz – w zależności od wersji, rynku i normy emisji – układu DPF. W starszych odmianach K9K większe znaczenie mają też zaniedbania olejowe."
  - question: "Ile kosztuje wymiana rozrządu w Kangoo 1.5 dCi?"
    answer: "Wymiana paska rozrządu z pompą wody w Kangoo 1.5 dCi kosztuje orientacyjnie 1200–2000 zł w niezależnym warsztacie. Typowy interwał to 120 000–160 000 km lub 5–6 lat, ale termin trzeba potwierdzić dla konkretnego kodu silnika."
---

## Dane techniczne 1.5 dCi w Renault Kangoo

Silnik 1.5 dCi nosi fabryczne oznaczenie [K9K](https://en.wikipedia.org/wiki/Renault_K-Type_engine) i ma pojemność 1461 cm³. To czterocylindrowy diesel 8V SOHC z paskiem rozrządu, przy czym osprzęt, układ wtryskowy, norma emisji i obecność DPF zależały od konkretnego kodu jednostki, rocznika oraz rynku.

W Renault Kangoo 1.5 dCi nie warto patrzeć wyłącznie na samą moc. Dla użytkownika ważniejsze są także skrzynia biegów, wersja nadwozia, długość auta oraz to, czy mamy do czynienia z modelem przed liftingiem z lat 2008–2013, czy po liftingu od 2013 roku.
...
Po liftingu w 2013 roku część wersji otrzymała zmieniony osprzęt i inne konfiguracje układu emisji spalin. Właśnie dlatego w praktyce numer silnika i kod K9K są ważniejsze niż sama nazwa 1.5 dCi.
...
W praktyce 75 KM to podstawowa odmiana do spokojnej jazdy miejskiej i lekkiej pracy. Przy większym obciążeniu 500–700 kg wyraźnie lepiej wypada wariant 90 KM, który dzięki 200 Nm jest bardziej uniwersalny w codziennej eksploatacji.

Wersja 110 KM z momentem 240 Nm będzie najlepsza dla kierowców jeżdżących w trasie, po drogach szybkiego ruchu albo regularnie z pełnym ładunkiem. Jeśli liczy się kompromis między spalaniem a funkcjonalnością, najbezpieczniejszym wyborem pozostaje zwykle 90 KM.
...
Istotne znaczenie ma też wersja nadwozia. Dłuższe Kangoo Maxi ze względu na większą masę i gorszą aerodynamikę zwykle może zużywać o około 0,3–0,8 l/100 km więcej niż krótsza odmiana przy tej samej jednostce napędowej.
...
Słabsze odmiany bywają nieco oszczędniejsze, ale różnice nie zawsze są duże. W codziennym użytkowaniu większy wpływ na wynik ma masa auta, długość nadwozia i sposób eksploatacji niż sama moc wpisana w dowodzie.
...
W praktyce najbardziej ekonomiczna jest nie tyle konkretna moc, ile dobrze utrzymany egzemplarz z wersją właściwie dobraną do pracy. Do miasta i lekkiego ładunku wystarczy 75 KM, ale przy regularnych trasach i cięższej eksploatacji 90 KM lub 110 KM zwykle okazują się rozsądniejszym wyborem.
{{% /expert %}}
...
Ocena awaryjności 1.5 dCi w Kangoo wymaga rozdzielenia roczników. Inne ryzyka dotyczą wcześniejszych egzemplarzy z początku produkcji Kangoo II, a inne aut po liftingu, w których większe znaczenie mają układy oczyszczania spalin i osprzęt zależny od normy emisji.
...
Przy zakupie używanego Kangoo warto koniecznie sprawdzić korekty wtrysków na CLIP/OBD, ciśnienie doładowania, historię wymiany rozrządu, obecność opiłków w filtrze paliwa, stopień zapełnienia DPF, szczelność dolotu, dymienie na zimno i na ciepło oraz numer i kod silnika K9K.
...
Silnik K9K ma opinię jednostki oszczędnej i dobrze znanej warsztatom, ale nie jest to diesel, którego da się ocenić jednym zdaniem. W Renault Kangoo 1.5 dCi bardzo dużo zależy od rocznika, kodu silnika, obecności DPF i jakości wcześniejszego serwisu.
...
Najważniejsze zalety tej jednostki to niskie spalanie, prosta architektura 8-zaworowa i szeroka dostępność części. Dodatkowo wiele warsztatów dobrze zna ten silnik, co ułatwia diagnostykę oraz naprawy.
...
Pojemność układu olejowego wynosi około 4,5–4,8 l w zależności od wersji. Dla odmian z DPF zwykle stosuje się RN0720 / ACEA C4 5W-30, a w części wersji bez DPF należy trzymać się innych aprobat Renault zgodnie z instrukcją i kodem silnika.
...
Nie ma sensu podawać jednej rocznej sumy kosztów serwisowych dla wszystkich wersji, bo zbyt wiele zależy od przebiegu, typu eksploatacji i osprzętu konkretnego egzemplarza. Znacznie ważniejsze jest to, by przed zakupem potwierdzić kod K9K, historię rozrządu i rodzaj układu emisji spalin.

Kangoo 1.5 dCi bezpośrednio konkuruje z Dacią Dokker wyposażoną w ten sam silnik K9K. W Dokkerze występowały różne odmiany mocy w zależności od rocznika, w tym nie tylko 75 i 90 KM, ale także 95 KM.