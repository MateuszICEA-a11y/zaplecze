...
h1: "Toyota Proace – kompletny przewodnik"
parent: ""
type: "page"
volume: 14800
...
Pierwsza Toyota ProAce była bliźniakiem modeli Peugeot Expert II, Citroën Jumpy II i Fiat Scudo. Produkcją zajmowała się fabryka Sevel Nord we Francji, a sama konstrukcja bazowała na starszej generacji dostawczych modeli PSA.

W gamie były diesle **1.6 i 2.0**, a nadwozie występowało w długościach **L1 i L2**. To był klasyczny średni van poprzedniej epoki – prostszy technicznie, ale dziś wyraźnie starszy od drugiej generacji.
...
Po liftingu z 2024 r. zmieniono pas przedni, multimedia i część systemów bezpieczeństwa. Utrzymano też wersję elektryczną z akumulatorami **50 i 75 kWh**.

W dieslach nadal spotyka się **2.0 D-4D 145 i 177 KM** – zależnie od rynku. To ważne, bo przy zakupie używanego albo nowego auta sama nazwa „Proace II” nie mówi jeszcze wszystkiego o napędzie i wyposażeniu.

## Silniki ProAce'a

Toyota Proace II występuje z dieslami 1.5 i 2.0 D-4D oraz z napędem elektrycznym. Najważniejsze jest jedno: oferta silnikowa zależy od rocznika, a starsze auta z pierwszych lat produkcji mogą mieć jeszcze inne diesle niż obecna gama 1.5 i 2.0.
...
|---|---:|
| Szerokość całkowita z lusterkami | ok. 2204 mm |
...
- **Kamper na bazie Proace Verso** – najczęściej zabudowa niezależnych firm, zwykle z łóżkiem o długości **190–200 cm**, dachem sypialnym i modułową kuchnią. Homologacja zależy od wykonawcy zabudowy.
...
Toyota Proace ma mechanikę znaną z bliźniaczych modeli PSA, więc typowe problemy są dobrze rozpoznane przez warsztaty. W praktyce warto rozdzielić usterki według generacji, bo ProAce I i ProAce II mają inne słabe punkty.

### ProAce I (2013–2016) – korozja nadwozia

W starszej generacji najczęściej wraca temat korozji progów i dolnych partii nadwozia. Przy zaniedbanych egzemplarzach naprawa blacharsko-lakiernicza progu kosztuje zwykle **1200–2500 zł** za stronę.
...
- amortyzatory osi przedniej komplet z robocizną – **800–1600 zł**
- tarcze i klocki przód komplet z robocizną – **700–1400 zł**
...
Poniżej orientacyjne ceny nowych egzemplarzy.

| Wersja nowa | Cena orientacyjna netto |
|---|---:|
| Proace Van Medium 1.5 D-4D 120 | od ok. 150 000 zł |
| Proace Van Long 2.0 D-4D 145 | od ok. 160 000–170 000 zł |
| Proace Van 2.0 D-4D 177 EAT8 | od ok. 175 000–185 000 zł |
| Proace Electric 50 kWh | od ok. 180 000–190 000 zł |
