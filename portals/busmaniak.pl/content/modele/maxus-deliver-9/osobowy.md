...
| Konfiguracja | Łączna liczba miejsc | Charakter wersji | Bagażnik | Uwagi |
|-------------|----------------------|------------------|----------|-------|
| Bus 9 | 9 łącznie z kierowcą | typowa wersja transferowa | większy | najłatwiejsza do pogodzenia z kat. B przy odpowiednim DMC |
| Bus 14 | 14 łącznie z kierowcą | minibus pasażerski | mniejszy | wymogi prawa jazdy zależą od liczby pasażerów poza kierowcą |
| Bus 17 | 17 łącznie z kierowcą | minibus pasażerski | minimalny | trzeba uwzględnić limity D1 dotyczące pasażerów i długości |
| Minibus 9+1 | 10 łącznie z kierowcą | wariant zabudowy | zależny od układu wnętrza | zapis 9+1 oznacza 9 pasażerów + kierowca |
...
|----------|--------------------------------------|
| DMC | 3,5 t lub 4,1 t / 5,0 t – zależnie od wersji i zabudowy |
| Homologacja | M1, M2 lub M3 – zależnie od liczby miejsc i DMC |
| Masa własna | zależna od konkretnej zabudowy pasażerskiej |
| Rezerwa masy na pasażerów | liczona według homologacji, np. przy założeniu 68 lub 75 kg na osobę |
...
W przypadku busa pasażerskiego wyposażenie bardzo często zależy od poziomu zabudowy. Dlatego bezpieczniej mówić o elementach typowych dla wybranych wersji niż o jednej, uniwersalnej liście „seryjnej” dla każdego Delivera 9 osobowego.

### Wyposażenie seryjne

- Oświetlenie sufitowe LED
- Uchwyty przy miejscach pasażerskich
- Okna otwierane lub stałe przeszklenie
- System audio dla kabiny i części pasażerskiej

Wcześniej wskazane nawiewy klimatyzacji dla każdego rzędu siedzeń oraz USB przy każdym fotelu nie powinny być traktowane jako uniwersalny standard. Takie elementy mogą występować w wybranych wersjach lub zabudowach, ale wymagają potwierdzenia w specyfikacji konkretnego auta.

Z punktu widzenia bezpieczeństwa pasażerów przy zakupie trzeba sprawdzić co najmniej: liczbę poduszek powietrznych, obecność ESC, ABS, EBD, asystenta ruszania pod górę, AEB, LDW, kamery cofania lub czujników, mocowań ISOFIX – jeśli występują – oraz rodzaj pasów bezpieczeństwa na wszystkich miejscach.
...
|--------------|-------------|
| Auto bazowe | sam pojazd w wersji wyjściowej |
| Zabudowa 9-osobowa | fotele, przeszklenie, wykończenie wnętrza, ewentualna klimatyzacja i ogrzewanie |
| Zabudowa 14-osobowa | większa liczba siedzeń, układ komunikacyjny, elementy bezpieczeństwa i homologacja |
| Zabudowa 17-osobowa | maksymalne zagęszczenie wnętrza, ograniczona przestrzeń bagażowa, formalności homologacyjne |
| Rejestracja i odbiory | dokumentacja zabudowy, badania i wpisy wynikające z homologacji |
...
| Model / rodzina | Zakres zastosowania w segmencie | Liczba miejsc | DMC | Napęd |
|-----------------|----------------------------------|---------------|-----|-------|
| Maxus Deliver 9 osobowy | bus 9-os. i zabudowy minibusowe | 9–17 łącznie z kierowcą | 3,5 t / 4,1 t / 5,0 t – zależnie od wersji | RWD |
| Mercedes Sprinter Transfer/Tourer | minibus i przewozy osobowe | zależnie od wersji | zależnie od wersji | zależnie od wersji |
| VW Crafter Kombi/Minibus | przewozy osobowe i pracownicze | zależnie od wersji | zależnie od wersji | zależnie od wersji |
| Ford Transit Minibus | przewozy osobowe | zależnie od wersji | zależnie od wersji | FWD / RWD / AWD – zależnie od wersji |
| Iveco Daily Minibus | cięższe zastosowania pasażerskie | zależnie od wersji | zależnie od wersji | zależnie od wersji |
