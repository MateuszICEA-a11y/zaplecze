...
Gamę silnikową trzeba rozdzielić według okresu produkcji. Wcześniej stosowano jednostki 2.3 MultiJet w różnych wariantach mocy zależnie od roku i rynku, a po 2021 r. pojawił się 2.2 MultiJet3 m.in. w wersjach 120, 140, 160 i 180 KM. Kwestia AdBlue zależy od normy Euro i konkretnej wersji homologacyjnej, więc nie należy upraszczać jej do jednej granicy rocznikowej.
{{% /info %}}
...
1. **Transport mebli** – łatwiejsze ustawienie wysokich elementów przy ścianie, możliwość montażu listew i relingów
2. **Dystrybucja palet** – załadunek palet odbywa się zwykle od tyłu przez drzwi lub przez windę; załadunek boczny wózkiem jest możliwy tylko przy odpowiedniej specyfikacji zabudowy, np. z kurtyną lub dużymi drzwiami bocznymi
