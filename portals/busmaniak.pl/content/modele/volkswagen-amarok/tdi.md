...
faq:
  - question: "Który TDI w Amaroku jest lepszy – 2.0 czy V6?"
    answer: "Do firmy i codziennej pracy zwykle wystarczy 2.0 TDI lub 2.0 BiTDI, zwłaszcza jeśli priorytetem są niższe koszty utrzymania. V6 3.0 TDI lepiej pasuje do częstego holowania i cięższej eksploatacji – homologowany uciąg w zależności od wersji sięga około 3,0–3,5 t, 2.0 BiTDI 180 KM przyspiesza do 100 km/h w około 10–11 s, a mocne V6 z overboostem w około 7,9 s. W praktyce różnice w spalaniu zwykle mieszczą się w przedziale 0,5–1,5 l/100 km."
  - question: "Ile pali Amarok TDI?"
    answer: "W praktyce 2.0 TDI i 2.0 BiTDI najczęściej mieszczą się w przedziale około 7,5–11,0 l/100 km w zależności od obciążenia, a V6 zwykle około 8,0–11,5 l/100 km. Z przyczepą spalanie rośnie wyraźnie i często przekracza 12 l/100 km."
  - question: "Jakie usterki ma Amarok TDI?"
    answer: "W 2.0 TDI i 2.0 BiTDI częściej powracają problemy osprzętu i układów emisji – EGR, DPF, klapa gasząca, przewody dolotu, wtryskiwacze oraz chłodnica EGR. W 3.0 V6 TDI warto zwrócić uwagę na EGR/AdBlue oraz możliwe wycieki z chłodnicy oleju, termostatu i osprzętu."
sources:
...
Dwie generacje Amaroka oznaczają dwie różne architektury auta. Amarok I rozwijano jako własną konstrukcję Volkswagena, natomiast Amarok II, powstały we współpracy z Fordem, bazuje na architekturze Rangera nowej generacji T6.2 i jest produkowany w Silverton w RPA. To ważne, bo gama silnikowa i konfiguracje napędu nie są identyczne na wszystkich rynkach.

Z punktu widzenia użytkownika BusManiak.pl liczą się nie tylko moce, lecz także parametry pracy. W Amaroku II uciąg przyczepy z hamulcem sięga 3500 kg, a ładowność wynosi około 1,0–1,2 t w zależności od wersji. To właśnie te wartości, obok prześwitu i możliwości brodzenia, w praktyce decydują o przydatności pickupa w firmie.
...
Na rynku wtórnym najczęściej spotyka się odmiany 163 i 180 KM. W praktyce to rozsądny wybór do pracy, zwłaszcza jeśli auto nie jeździ stale z ciężką przyczepą i nie ma zastępować dużego SUV-a na autostradzie.
...
W zależności od wersji Amarok II korzysta z dołączanego 4MOTION z reduktorem albo ze stałego 4MOTION. To ważne rozróżnienie, bo inaczej zachowuje się auto robocze z klasycznym napędem dołączanym, a inaczej bogatsza wersja nastawiona również na codzienną jazdę po asfalcie.

{{% expert name="Marek Kowalczyk" %}}
Amarok I z 3.0 V6 TDI to jeden z najbardziej udanych pickupów klasy średniej do cięższej pracy i holowania. Jeśli jednak auto ma głównie wozić ekipę, narzędzia i okazjonalnie ciągnąć przyczepę, rozsądniej wypada 2.0 BiTDI – zwłaszcza 180 KM. Różnica osiągów względem V6 jest odczuwalna, ale koszty zakupu i serwisu pozostają niższe.
{{% /expert %}}

## Spalanie – realne wartości

Katalog i codzienna eksploatacja to zwykle dwie różne historie. W pickupie wiele zależy od opon, zabudowy paki, masy przewożonego ładunku i tego, czy auto regularnie pracuje z przyczepą.
...
- **Rozrząd na pasku** – wymianę warto wiązać z harmonogramem dla konkretnego silnika i rocznika; przy tej operacji zwykle wymienia się także pompę wody
...
- **Turbodoładowanie** – układ jest bardziej złożony niż w zwykłym 2.0 TDI, więc zaniedbania serwisowe szybciej dają o sobie znać przy większych przebiegach

### 3.0 V6 TDI

- **EGR i AdBlue** – elementy układu emisji w codziennym serwisie wymagają największej uwagi
...
Utrzymanie Volkswagena Amaroka TDI jest wyraźnie droższe niż utrzymanie typowego SUV-a z dieslem, bo dochodzi masa własna, roboczy charakter auta i obsługa napędu 4x4. Największe różnice między 2.0 a V6 widać przy większych naprawach oraz w kosztach osprzętu.
...
W pickupie trzeba doliczyć także serwis napędu 4x4. Oleje w moście i reduktorze zwykle wymienia się co 60–120 tys. km, w zależności od sposobu użytkowania i obciążenia.
