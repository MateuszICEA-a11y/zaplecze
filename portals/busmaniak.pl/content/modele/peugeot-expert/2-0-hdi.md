...
faq:
  - question: "Ile pali Peugeot Expert 2.0 HDi?"
    answer: "Zużycie paliwa zależy od wersji nadwozia, długości L1 lub L2, obciążenia i stylu jazdy. W praktyce wartości trzeba traktować orientacyjnie, bo Expert II występował jako furgon, kombi/Tepee oraz w konfiguracjach o różnej masie."
  - question: "Który wariant 2.0 HDi w Expercie jest najlepszy?"
    answer: "Wybór zależy od zastosowania. W porównaniu z 1.6 HDi zwykle o mocy 90 lub 90/95 KM i momencie ok. 180–210 Nm, 2.0 HDi oferuje ok. 300–340 Nm, więc wyraźnie lepiej radzi sobie z ładunkiem i jazdą trasową."
  ...
  - question: "Jakie są typowe usterki 2.0 HDi w Expercie?"
    answer: "Najczęściej powtarzają się problemy z osprzętem i eksploatacją: kłopoty z układem DPF/FAP przy jeździe miejskiej, zużycie dwumasy, awarie osprzętu dolotu i podciśnienia, usterki wtrysku w części wersji oraz wycieki oleju zależne od odmiany pokrywy i osprzętu."
---
...
W Peugeocie Expert drugiej generacji jednostka 2.0 HDi występowała w różnych odmianach nadwoziowych. To ważne, bo Expert II był oferowany jako furgon, kombi/Tepee oraz platforma, w długościach L1 i L2, a różnice masy własnej liczy się w setkach kilogramów. Z tego powodu osiągi, spalanie, DMC, ładowność i parametry użytkowe trzeba zawsze odnosić do konkretnej konfiguracji auta.
...
Normę emisji spalin trzeba wiązać z rocznikiem i konkretną wersją homologacyjną, a nie wyłącznie z samą mocą. W Expercie II nie da się jej bezpiecznie przypisać do każdej odmiany 2.0 HDi bez sprawdzenia konkretnego egzemplarza.
...
W praktyce serwisowej istotne są też konkretna aprobata olejowa PSA oraz pojemność układu smarowania przy wymianie z filtrem. Te dane należy potwierdzić na podstawie numeru VIN w dokumentacji producenta lub w Service Box, bo mogą zależeć od wersji silnika i rocznika.

## Spalanie Experta 2.0 HDi

W przypadku modelu użytkowego spalanie zawsze trzeba odczytywać z dużą ostrożnością. Peugeot Expert 2.0 HDi występował w wersjach L1 i L2, jako furgon oraz odmiana osobowa, a masa auta i obciążenie potrafią zmienić wynik bardziej niż sama różnica mocy.

### Realne zużycie paliwa 2.0 HDi

Zamiast podawać pozornie dokładne wartości dla każdej wersji, lepiej przyjąć zasadę: im cięższe nadwozie, dłuższa zabudowa i większy ładunek, tym wyższe zużycie paliwa. Dotyczy to szczególnie porównania L1 z L2 oraz furgonu z wersją 9-osobową.

Przy ocenie spalania warto rozdzielać przynajmniej cztery scenariusze: trasa 90 km/h, trasa 120 km/h, miasto oraz jazda z ładunkiem 500–1000 kg. Osobno należy traktować też wieloosobowe odmiany pasażerskie, bo pełna obsada mocno zmienia wynik.

### Wpływ długości nadwozia na spalanie Experta

Dłuższy Expert L2 z reguły zużywa więcej paliwa niż L1, bo ma większą masę własną i większe opory ruchu. Różnice nie wynikają więc wyłącznie z samego silnika, lecz z całej konfiguracji pojazdu.

To samo dotyczy porównania wariantów 120 i 163 KM. Wyższa moc nie musi z góry oznaczać stałej różnicy w spalaniu, bo w praktyce znaczenie mają też przełożenia, masa wersji nadwoziowej, obciążenie i styl jazdy.
...
- **Turbosprężarka i sterowanie doładowaniem** – często pojawiają się problemy z zacierającą się geometrią, nieszczelnościami przewodów doładowania i intercoolera oraz usterkami przewodów podciśnienia.
...
W autach PSA ważny jest też sam układ FAP/DPF. W zależności od egzemplarza samochód może korzystać z dodatku do paliwa Eolys i mieć osobny zbiornik dodatku. Orientacyjny interwał uzupełniania to zwykle ok. 120–180 tys. km, a przy obsłudze trzeba pamiętać nie tylko o samym uzupełnieniu, lecz także o wyzerowaniu licznika serwisowego.

{{% info title="Na co zwrócić uwagę przy oględzinach?" icon="engineering" %}}
Przed zakupem warto sprawdzić korekty wtrysków na zimno i na ciepło, ciśnienie różnicowe DPF, historię uzupełniania Eolys, stan dwumasy przy ruszaniu, dymienie pod obciążeniem, wycieki spod pompy podciśnienia i pokrywy oraz potwierdzenie wymiany rozrządu z datą i przebiegiem.
{{% /info %}}
...
- **Uniwersalność** – sprawdza się zarówno w furgonie, jak i w cięższych wersjach osobowych
...
W porównaniu z Oplem Vivaro mówimy o konkurencie z tego samego segmentu, a nie o modelu na tej samej platformie. Z kolei Toyota ProAce pierwszej generacji była technicznie spokrewniona z Expert/Jumpy/Scudo, więc porównanie tych aut jest bardziej bezpośrednie.
...
W przypadku tego modelu warto oddzielić zwykłą eksploatację od kosztów awarii. Taki podział lepiej pokazuje realne wydatki niż jedna zbiorcza kwota roczna, zwłaszcza że van użytkowy może w ciągu roku pokonywać bardzo różne dystanse.
...
| Element | Kiedy zwykle wraca problem |
|---------|--------------------------|
...
*Źródła i metodologia: dane należy weryfikować w instrukcji obsługi PSA, katalogu homologacyjnym oraz Service Box na podstawie numeru VIN. Dla spalania i kosztów serwisu kluczowe jest odniesienie do konkretnej wersji nadwozia, długości L1/L2, masy i sposobu eksploatacji.*