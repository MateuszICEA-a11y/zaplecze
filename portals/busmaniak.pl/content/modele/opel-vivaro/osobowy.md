...
faq:
  - question: "Ile miejsc ma Opel Vivaro osobowy?"
    answer: "Liczba miejsc zależy od wersji, długości i rynku. W typowych odmianach osobowych i półosobowych spotyka się konfiguracje 8- i 9-miejscowe, a układ siedzeń nie jest ograniczony do jednego schematu."
...
Liczba miejsc w osobowych i półosobowych odmianach Vivaro nie sprowadza się do jednego układu siedzeń. To zawsze kwestia konkretnej generacji, długości nadwozia i rynku sprzedaży.
...
W generacji C długości nadwozia mają już inne oznaczenia niż w starszych Vivaro. Zamiast mylącego L1/L2 lepiej używać fabrycznych nazw S, M i L, bo to one odpowiadają rzeczywistej ofercie modelu na platformie EMP2.

| Wersja | Długość | Układ siedzeń | Liczba miejsc |
|--------|---------|---------------|---------------|
| Combi S | 4606 mm | zależnie od wersji i rynku | 8 lub 9 |
| Combi M | 4956 mm | zależnie od wersji i rynku | 8 lub 9 |
| Combi L | 5306 mm | zależnie od wersji i rynku | 8 lub 9 |
| Zafira Life S | 4606 mm | zależnie od wersji i rynku | 8 lub 9 |
...
Jeśli mówimy o osobowym vanie Opla generacji C, poprawną nazwą modelu jest Zafira Life. To właśnie do niej odnoszą się kluczowe wymiary i parametry typowe dla osobowych odmian EMP2.

W praktyce najważniejsze są trzy długości nadwozia oraz to, jak producent mierzy bagażnik. Bez wskazania normy liczby bywają nieporównywalne.

Wymiary i parametry typowe dla osobowych odmian EMP2:
- **Długość nadwozia** – 4606 mm, 4956 mm lub 5306 mm
- **Rozstaw osi** – 2925 mm w wersji S, 3275 mm w wersjach M/L
- **Szerokość bez lusterek** – ok. 1920–1924 mm
- **Szerokość z lusterkami** – ok. 2204 mm
- **Wysokość** – zwykle poniżej 1900–1935 mm zależnie od wersji
- **DMC** – zwykle 2800–3100 kg zależnie od odmiany
...
- 1.5 D – 120 KM i ok. 300 Nm
- [2.0 D](/modele/opel-vivaro/2-0/) – 145 KM i ok. 340 Nm
- 2.0 D – 177 KM i ok. 400 Nm

W ofercie była też odmiana elektryczna:
- **Vivaro-e / Zafira-e Life** – 100 kW/136 KM i 260 Nm
- **Akumulator 50 kWh** – zasięg do ok. 230 km WLTP
- **Akumulator 75 kWh** – zasięg do ok. 330 km WLTP
...
Tutaj kluczowe jest rozróżnienie generacji. **Vivaro A i B** były technicznie spokrewnione z Renault Trafic, natomiast **Vivaro C** nie ma już wspólnej platformy ani gamy silnikowej z Trafikiem Passenger.
