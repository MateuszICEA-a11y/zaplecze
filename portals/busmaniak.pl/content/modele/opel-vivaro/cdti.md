...
date: 2026-03-26
lastmod: 2026-08-06
description: "Silniki CDTi w Oplu Vivaro A i B – dane techniczne, warianty mocy, spalanie, typowe usterki i koszty serwisu. Porównanie single turbo vs BiTurbo."
draft: false
...
lead: "Wysokoprężne jednostki stosowano w Oplu Vivaro od debiutu modelu w 2001 roku, choć oznaczenie handlowe CDTi zależało od rynku i rocznika. W gamie były zarówno proste 1.9, mocniejsze 2.5, późniejsze 2.0, jak i jednostki 1.6 o zmniejszonej pojemności w Vivaro B. Oto rzeczowy przewodnik po wariantach, spalaniu, typowych usterkach i kosztach serwisu."
faq:
  - question: "Który CDTi w Vivaro jest najlepszy?"
    answer: "2.0 CDTi 114–115 KM w Vivaro A to bardzo dobry kompromis osiągów i eksploatacji. W Vivaro B rozsądnym wyborem do większości zastosowań jest 1.6 CDTi 125 KM single turbo."
  - question: "Ile pali Vivaro CDTi?"
    answer: "Najczęściej około 6–10 l/100 km, zależnie od silnika, masy, zabudowy i stylu jazdy. Najmniej zwykle zużywa 1.6 CDTi, a najwięcej 2.5 CDTi pod obciążeniem."
  - question: "Czy 1.6 CDTi BiTurbo jest awaryjny?"
    answer: "Jest bardziej złożony od wersji single turbo, więc wymaga większej ostrożności przy zakupie. Potencjalne koszty napraw układu doładowania mogą być znaczne i mocno zależą od zakresu uszkodzeń."
---

## Dane techniczne silników CDTi w Oplu Vivaro

Oznaczenie CDTi to nazwa handlowa Opla dla diesli common rail. W praktyce Vivaro A i B korzystały z jednostek pochodzących z aliansu i wspólnej bazy technicznej z Renault – z kodami F9Q, G9U, M9R i R9M, stosowanymi również w Renault Trafic.

Warto od razu uporządkować gamę. Vivaro A generacji X83 produkowano od 2001 do 2014 roku, z liftingiem około 2006 roku, a Vivaro B od 2014 do 2019 roku. Przed liftingiem dominowały F9Q i G9U, po liftingu pojawiły się 2.0 M9R i zaktualizowane 2.5 G9U.
...
Poza samym silnikiem liczy się konfiguracja auta. Ładowność Vivaro zwykle wynosi około 1000–1200 kg zależnie od wersji L1H1 lub L2H1 oraz od DMC, która najczęściej mieści się w zakresie około 2,7–3,0 t. Pojemność przestrzeni ładunkowej to około 5,0 m³ dla L1H1 i około 5,9–6,0 m³ dla L2H1.

W praktyce przejście z Euro 3 na Euro 4 następowało w połowie lat 2000, a część wersji po liftingu miała fabryczny DPF – zależnie od rynku i rocznika. W Vivaro B 1.6 CDTI występował już z normami Euro 5 lub Euro 6, również zależnie od wersji i roku produkcji.
...
Atutem 1.9 jest prostsza budowa i szeroka dostępność części. Trzeba jednak pamiętać, że w zaniedbanych egzemplarzach pojawiają się problemy z panewkami, osprzętem i nieszczelnościami dolotu. Rozrząd zwykle wymienia się co około 120 tys. km lub co 5 lat, a koszt zależy od regionu i zakresu prac.
...
To jednostka dla kierowców, którzy często wykorzystują pełną ładowność auta albo cięższą zabudowę. Trzeba jednak liczyć się z wyższym spalaniem, a przy zakupie zwrócić uwagę na turbo, wtryski, kolektory oraz nieszczelności osprzętu. Zdolność holowania zawsze zależy od konkretnej wersji nadwozia, homologacji i danych z dowodu.

{{% info title="CDTi vs dCi – to ten sam silnik" icon="engineering" %}}
W Vivaro oznaczenie CDTi dotyczyło jednostek znanych także z modeli Renault pod oznaczeniem dCi. Dotyczy to kodów F9Q, M9R, G9U i R9M. Wiele części mechanicznych jest wspólnych, ale zgodność zawsze warto potwierdzać po VIN albo numerze OEM.
{{% /info %}}
...
BiTurbo 140 KM oferuje najlepsze osiągi w tej rodzinie, ale ma bardziej złożony osprzęt. W praktyce większej uwagi wymagają tu układy EGR, DPF, a w późniejszych wersjach Euro 6 także AdBlue i chłodnica EGR. Potencjalne koszty napraw układu BiTurbo mogą być znaczne i zależą od zakresu uszkodzeń.
...
Przy każdym używanym Vivaro CDTi warto przejść tę samą listę kontrolną. Diagnostyka korekt wtrysków, ciśnienie doładowania, szczelność intercoolera, stan dwumasy, błędy EGR i DPF, odpalanie na zimno, dymienie pod obciążeniem, korozja podwozia i progów oraz potwierdzona historia rozrządu i wymian oleju to absolutne minimum.
