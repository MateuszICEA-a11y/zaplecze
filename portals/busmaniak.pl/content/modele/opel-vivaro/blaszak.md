...
sources:
  - "dane techniczne i cenniki producenta z datą obowiązywania"
  - "katalogi techniczne oraz dokumenty homologacyjne dla poszczególnych wersji."
---
...
W Polsce nie można automatycznie łączyć homologacji N1 z pełnym odliczeniem VAT. Przy użytku mieszanym zwykle mówimy o odliczeniu 50%, a 100% wymaga spełnienia warunków podatkowych przewidzianych dla użytkowania firmowego.

Vivaro C (od 2019) korzysta z platformy EMP2 i konstrukcyjnie jest blisko spokrewniony z Peugeotem Expert oraz Citroënem Jumpy. W ogłoszeniach warto też odróżniać klasycznego blaszaka od wersji brygadowej/doublecab – ta druga ma krótszą pakę i inną ładowność.
...
| Objętość | 4,0 m³ | ok. 5,9–6,0 m³ | – | ok. 5,3 m³ | ok. 6,1 m³ w bazie |
| Europalety | 2 | 2 | – | 2 | 2 |

W Vivaro C liczą się także otwory załadunkowe. Tylne drzwi dają ok. 1282 mm szerokości i ok. 1220 mm wysokości, a boczne drzwi przesuwne – ok. 935 mm szerokości i ok. 1241 mm wysokości.
...
- **Masa własna furgonu z dieslem** – zwykle ok. 1660–1800 kg
...
W dostawczym Vivaro liczy się nie tylko sama moc, lecz także skrzynia, moment obrotowy i osprzęt emisyjny. Dla kupującego używane auto te cechy są często ważniejsze niż katalogowe spalanie.

Generacje A i B opierały się na innych układach napędowych niż obecne Vivaro C. W najnowszym modelu napęd trafia na przednią oś, a w zależności od wersji spotkamy 6-biegową skrzynię manualną lub 8-biegowy automat EAT8 przy wybranych 2.0 D.
...
W Vivaro C diesle 1.5 D i 2.0 D spełniają normę Euro 6 i korzystają z układu SCR/AdBlue. Na rynku wtórnym trzeba więc patrzeć nie tylko na silnik, lecz także na stan osprzętu AdBlue, NOx i DPF.

Osobną pozycją jest Vivaro-e. Elektryczna wersja występuje z akumulatorami 50 kWh lub 75 kWh oraz zasięgiem WLTP ok. 230 km i 330 km.

## Na co uważać przy zakupie Opla Vivaro blaszaka
...
Warto też pamiętać, że różne generacje mają różne słabe punkty. Bez tej wiedzy łatwo zestawić auta z podobnych ogłoszeń, które w praktyce niosą zupełnie inne ryzyko serwisowe.

- **Vivaro A** – sprawdź korozję progów i nadkoli, a także osprzęt diesli 1.9 i 2.5, dwumasę oraz wtrysk
- **Vivaro B** – w 1.6 CDTi i biturbo zwróć uwagę na EGR, DPF, turbo oraz łańcuch i osprzęt zależnie od wersji
...
Jeśli oglądasz wersję brygadową, porównaj ją z klasycznym furgonem nie tylko pod względem ceny, lecz także funkcjonalności. Doublecab ma krótszą pakę i inną ładowność, więc w praktyce nie zastępuje zwykłego blaszaka jeden do jednego.

## Ceny Vivaro blaszaka
...
Na wartość używanego egzemplarza najmocniej wpływają: długość M lub XL, liczba drzwi bocznych, automat EAT8, klimatyzacja, kamera cofania, przebieg 100 tys. wobec 250 tys. km, kraj pochodzenia oraz historia serwisowa. Między dwoma zbliżonymi rocznikami różnica może sięgać 15 000–30 000 zł.

W praktyce najtańsze są auta po flotach z wysokim przebiegiem, a najdroższe – dobrze wyposażone egzemplarze krajowe z udokumentowanym serwisem. W przypadku Vivaro-e o cenie dodatkowo w dużej mierze decyduje pojemność akumulatora.


{{% youtube %}}

## Porównanie Vivaro blaszaka z konkurencją

W segmencie średnich vanów same suche wymiary nie wystarczą. Dla firmy równie ważne są koszty eksploatacji, częstotliwość przeglądów, ceny podstawowego serwisu oraz realne spalanie pod obciążeniem.
...
|-------|---------------------------------|
| Opel Vivaro C | Pojemność ok. 5,3 m³ w M i ok. 6,1 m³ w bazie w XL, większa przestrzeń po użyciu Moduwork |
...
Jeśli porównujesz koszty floty, weź pod uwagę obok ceny zakupu także gwarancję producenta, ceny oleju i filtrów oraz spalanie przy realnym ładunku 500–800 kg. To właśnie te elementy najczęściej decydują, czy dany blaszak opłaca się bardziej od konkurenta.