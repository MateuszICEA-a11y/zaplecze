...
faq:
  - question: "Czy Multivan to to samo co Transporter?"
    answer: "Nie od generacji T7 (2021). Multivan T7 bazuje na platformie MQB, a Transporter T7 na platformie dostawczej rozwijanej we współpracy z Fordem. Do T6.1 Multivan należał do rodziny Transportera, ale stanowił odrębną osobową odmianę modelową, a nie tylko poziom wyposażenia."
  - question: "Jaka jest pojemność bagażnika Multivana T7?"
    answer: "380 l za trzecim rzędem siedzeń w krótszej wersji i 469 l w Long. Po złożeniu lub demontażu siedzeń pojemność rośnie odpowiednio do 4005 l i 4053 l."
  - question: "Ile kosztuje nowy Multivan?"
    answer: "Dokładna cena zależy od rynku, wersji i daty cennika. Bez wskazania miesiąca i roku oficjalnego cennika nie warto podawać precyzyjnych kwot."
---
...
| Wysokość | ok. 1903 mm | ok. 1903 mm |
| Rozstaw osi | 3124 mm | 3124 mm |
| Średnica zawracania | ok. 12,1 m | – |
| Liczba miejsc | 5–7 | 5–7 |
| Pojemność zbiornika paliwa | ok. 58 l | ok. 58 l |
| Bagażnik (za 3. rzędem) | 380 l | 469 l |
| Bagażnik (po złożeniu / demontażu siedzeń) | 4005 l | 4053 l |

W dostępnych tu danych brakuje pełnego zestawu mas i nacisków osi dla wszystkich odmian. Dotyczy to zwłaszcza DMC, masy własnej i dopuszczalnych obciążeń, które w Multivanie wyraźnie zależą od silnika, długości nadwozia i wyposażenia.

### Ładowność i przestrzeń ładunkowa

- **Ładowność** – ok. 640–873 kg, zależnie od wersji
- **System siedzeń** – niezależne fotele w 2. i 3. rzędzie, przesuwane na szynach, składane i wyjmowane
- **Masa przyczepy z hamulcem** – do 2500 kg, zależnie od wersji napędowej i homologacji
- **Homologacja** – M1, czyli auto osobowe, a nie typowy van użytkowy
...
Gama silnikowa Multivana T7 zmieniała się wraz z rocznikami i aktualizacjami oferty. To szczególnie ważne przy hybrydzie plug-in, bo w obiegu funkcjonują dane z dwóch różnych etapów rozwoju modelu.

| Silnik / układ | Moc | Moment | Skrzynia | Napęd |
|----------------|-----|--------|----------|-------|
| 1.5 TSI | 136 KM | 220 Nm | 7-bieg. DSG | FWD |
...
|----------|-------------------|----------------------|------------------------|--------------------------|
| Długość | 4973 mm | 5140 mm | ok. 5050 mm | 5306 mm |
| Miejsca | 5–7 | 7–8 | 8–9 | 8–9 |
