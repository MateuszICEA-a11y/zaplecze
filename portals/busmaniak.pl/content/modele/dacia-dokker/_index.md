...
lead: "Dacia Dokker to jeden z najbardziej opłacalnych kombivanów na rynku wtórnym – łączy prostą budowę z przestrzenią ładunkową, jakiej trudno szukać w tej cenie. Produkcja zakończyła się w marcu 2021 roku, ale model wciąż cieszy się dużym popytem wśród małych firm i rzemieślników."
faq:
  - question: "Jakie silniki ma Dacia Dokker?"
    answer: "Diesel 1.5 dCi (75–115 KM), benzyna 1.6 SCe (82–102 KM), turbo 1.2 TCe (115 KM) i 1.3 TCe (102–130 KM po liftingu) oraz 1.6 LPG (102 KM)."
  - question: "Jakie są wymiary Dacii Dokker?"
    answer: "Długość 4361 mm, szerokość 1751 mm, wysokość 1824 mm (osobowy) / 1819 mm (Van), rozstaw osi 2810 mm. Bagażnik wersji osobowej 800 l, po złożeniu siedzeń do 3000 l."
  - question: "Jaka jest ładowność Dacii Dokker Van?"
    answer: "750–970 kg w zależności od wersji. Przestrzeń ładunkowa 3,1 m³, z systemem Easy Seat długość załadunku do 3,11 m. DMC wynosi 1959 kg."
  - question: "Jakie są typowe usterki Dacii Dokker?"
    answer: "Rozciąganie łańcucha rozrządu w 1.2 TCe (od 60–80 tys. km), cewki zapłonowe w benzyniakach (50–100 tys. km), świece żarowe w dCi (80–120 tys. km), nierównomierne zużycie klocków hamulcowych, usterki centralnego zamka i cienki lakier."
...
Dokker występował tylko w jednej generacji, ale w praktyce da się go podzielić na dwie wyraźne fazy modelowe: przed liftingiem i po liftingu. To ważne przy zakupie używanego egzemplarza, bo różnice dotyczą nie tylko wyglądu, lecz także wyposażenia i dostępnych wersji silnikowych.

### Faza I (2012–2016) – debiut modelu

Model zadebiutował w 2012 roku jako osobowy Dokker i dostawczy Dokker Van. Produkcję prowadzono w Tangerze, a bazą była platforma M0/B0, dobrze znana z innych prostych konstrukcji koncernu Renault.
...
Po liftingu z lat 2016/2017 Dokker dostał nowy grill i reflektory, zmienione zderzaki oraz odświeżone wnętrze. Doszedł też nowszy system multimedialny Media Nav oraz korekty wyposażenia, które poprawiły codzienną użyteczność auta.
...
| 1.6 MPI/SCe 100/102 | benzyna    | 100–102 KM | 148–156 Nm | łańcuch lub pasek w zależności od wersji i rynku | Euro 5/6   | 7,0–8,2 l/100 km    | dobra baza pod LPG                                  |
...
Najpopularniejszy na rynku wtórnym 1.5 dCi ma sens, jeśli Dokker pokonuje dłuższe trasy i regularnie pracuje pod obciążeniem. W codziennym użytkowaniu to właśnie ten silnik zwykle daje najlepszy kompromis między spalaniem a elastycznością.
...
Dokker dzieli platformę z Renault Lodgy, Dacią Sandero i Renault Kangoo II. Obsługa serwisowa jest taka sama – mechanicy przyzwyczajeni do aut Renault obsłużą Dokkera bez problemów. Części zamienne są wspólne z innymi modelami.
{{% /info %}}

## Dane techniczne i wymiary

Dacia Dokker miała jeden rozstaw osi i jedną długość nadwozia, ale wyraźnie różniła się przeznaczeniem w zależności od wersji. Osobówka stawiała na pojemny bagażnik, a Van na prostą, dużą przestrzeń ładunkową i sensowną ładowność.
...
Z praktycznego punktu widzenia ważniejsze od samych wymiarów zewnętrznych są parametry przestrzeni ładunkowej. W Vanie długość paki wynosi 1900 mm, a z Easy Seat rośnie do 3110 mm. Szerokość między nadkolami to 1170–1200 mm, a wysokość progu załadunku około 570 mm.

![Dacia Dokker Van – kompaktowy kombivan dostawczy](/images/dacia-dokker-hero.webp)

## Wersje nadwozia – kombi, Van, Stepway

Dokker występował w kilku odmianach, które z zewnątrz są do siebie podobne, ale w praktyce służą do zupełnie innych zadań. Przy zakupie warto patrzeć nie tylko na silnik, lecz także na konfigurację kabiny, przeszklenie i sposób otwierania przestrzeni ładunkowej.
...
W tej odmianie można było opcjonalnie zamówić dwoje przesuwnych drzwi bocznych. To detal, ale przy dzieciach, paczkach albo pracy w mieście robi sporą różnicę.
...
Ładowność wynosi zwykle 750–800+ kg. To nie rekord segmentu, ale przy cenach zakupu i prostocie konstrukcji Dokker nadal pozostaje bardzo mocną propozycją na rynku wtórnym.
...
Stepway to wersja stylizowana, z relingami, nakładkami ochronnymi i bogatszym wyposażeniem. Prześwit wynosił 190 mm lub był o około 20–40 mm wyższy, zależnie od specyfikacji rynkowej.
...
Na bazie Dokkera powstawały także lekkie kamper-vany, auta serwisowe i chłodnicze oraz wersje z zabudową regałową wykonywane przez firmy zewnętrzne. Fabrycznie nie było klasycznego podwozia do zabudowy, więc większość takich przeróbek to robota niezależnych wykonawców.
...
W wolnossących benzyniakach 1.6 problemy są zazwyczaj prostsze i tańsze. Najczęściej kończy się na osprzęcie zapłonu i drobnych elementach eksploatacyjnych.
...
W Dokkerze potrafią powracać drobne problemy z zamkami, siłownikami drzwi i układem klimatyzacji. To nie są awarie unieruchamiające auto na tydzień, ale warto je uwzględnić przy oględzinach.
...
Lokalna naprawa progu to zwykle **600–1500 zł**. Lakierowanie pojedynczego elementu mieści się najczęściej w przedziale **500–900 zł**.
...
|--------------------------------|--------------|-----------------------------------------------------------------------------------|
| Nowy w salonie (historycznie) | lata 2012–2021 | od ok. 37 900 zł za bazowego vana na początku sprzedaży; po liftingu i w bogatszych wersjach osobowych oraz Stepway zwykle 55 000–70 000 zł |
