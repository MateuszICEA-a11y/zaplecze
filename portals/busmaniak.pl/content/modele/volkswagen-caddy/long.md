...
Porównanie Caddy i Caddy Long w V generacji:

| Parametr                        | Caddy       | Caddy Long  |
|---------------------------------|-------------|-------------|
| Długość (mm)                    | 4500        | 4853        |
| Rozstaw osi (mm)                | 2755        | 2970        |
| Szerokość bez lusterek (mm)     | 1855        | 1855        |
| Wysokość (mm)                   | ok. 1798–1836 | ok. 1798–1836 |
| Bagażnik – 5 os. (l, VDA)       | 1213        | 1720        |
...
Dla wersji użytkowej istotne są także same wymiary przestrzeni ładunkowej. W wydłużonym Caddy Cargo objętość wynosi około 4,2 m³, a nie 3,7 m³ jak w krótszej odmianie. To właśnie dlatego Volkswagen Caddy Long jest częstym wyborem wśród kurierów, serwisantów i małych firm.

{{% info title="Long vs Maxi – wymiary" icon="engineering" %}}Caddy V w wydłużonej wersji ma 4853 mm długości i 2970 mm rozstawu osi. Wcześniejszy Caddy Maxi generacji 2K po faceliftingu miał około 4878 mm długości i 3006 mm rozstawu osi, więc parametry są zbliżone, ale nie identyczne.{{% /info %}}

## Silniki {#silniki}

### Diesle i benzyny w Caddy Long

Gama napędowa wydłużonej wersji jest zasadniczo taka sama jak w krótszym Caddy V, ale warto ją uporządkować. Na rynku europejskim występowały przede wszystkim:

- **[2.0 TDI](/modele/volkswagen-caddy/tdi/) 75 KM** – podstawowy diesel do lekkiej pracy
- **2.0 TDI 102 KM** – najbardziej uniwersalny wybór
- **2.0 TDI 122 KM** – najlepsza opcja przy trasach i większym obciążeniu
- **1.5 TSI 114/116 KM** – podstawowa benzyna w Caddy V
