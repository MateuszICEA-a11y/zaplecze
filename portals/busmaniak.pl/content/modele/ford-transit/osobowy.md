...
Trzeba też uważać z homologacją. Nie da się z góry założyć, że każda odmiana pełnowymiarowego Transita do przewozu osób ma zawsze homologację M1 – zależy to od konkretnej wersji i liczby miejsc wpisanej w dokumentach.
...
|---|---|---|---|---|
| Długość całkowita | ok. 4972 mm lub ok. 5050 mm zależnie od generacji | ok. 5340 mm lub ok. 5450 mm zależnie od generacji | 6019 mm | 6437 mm |
| Liczba miejsc | 8–9 | 8–9 | 8–9 | 8–9 |
| Wysokość całkowita | zależna od wersji | zależna od wersji | zależna od wersji | zależna od wersji |
| Rozstaw osi | zależny od wersji | zależny od wersji | zależny od wersji | zależny od wersji |
| Szerokość z lusterkami | zależna od wersji | zależna od wersji | zależna od wersji | zależna od wersji |
| Liczba drzwi przesuwnych | zależna od wersji | zależna od wersji | zależna od wersji | zależna od wersji |
| Homologacja | zależna od konkretnej wersji | zależna od konkretnej wersji | zależna od konkretnej wersji | zależna od konkretnej wersji |
...
Oferta napędów zależy od tego, czy mówimy o starszym modelu, nowej generacji Tourneo Custom czy o osobowej odmianie pełnowymiarowego Transita. Nie można więc sprowadzać całej gamy do jednego diesla 2.0 EcoBlue i jednej skrzyni.
...
Przy cenach trzeba zawsze podać, czy chodzi o kwoty brutto czy netto oraz jaki cennik jest podstawą wyliczeń, na przykład „Polska, stan na marzec 2026”. To szczególnie ważne przy porównaniu diesla, PHEV i wersji elektrycznej, bo różnice cenowe mogą być bardzo duże.
