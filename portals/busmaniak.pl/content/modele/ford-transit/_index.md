...
h1: "Ford Transit – kompletny przewodnik"
parent: ""
type: "page"
volume: 49500
...
lead: "Ford Transit VIII to najpopularniejszy dostawczak w Polsce – dostępny w 12 konfiguracjach nadwozia, z silnikami EcoBlue 2.0 od 105 do 185 KM i ładownością do ok. 2100–2200 kg w zależności od wersji i rynku."
faq:
  - question: "Ile m³ ma Ford Transit L2H2?"
    answer: "Ford Transit L2H2 ma pojemność ładowni około 10,0 m³. Długość przestrzeni ładunkowej wynosi około 3044 mm, szerokość maksymalna 1784 mm, szerokość między nadkolami 1392 mm, a wysokość ładowni około 1886 mm. W dłuższych wersjach L3/L4 można przewieźć 3 europalety; w L2 zależy to od układu i rodzaju ładunku."
  - question: "Jaki silnik ma Ford Transit VIII?"
    answer: "Ford Transit VIII jest oferowany z silnikiem 2.0 EcoBlue (od 2016 r.) w wersjach 105, 130, 170 i 185 KM. Starsze egzemplarze z lat 2014–2016 mają 2.2 TDCi o mocy 100, 125 lub 155 KM."
...
Trzeba też uporządkować nazewnictwo. Duży Ford Transit z lat 2014–obecnie bywa opisywany jako Mk8 / generacja VIII w uproszczonej nomenklaturze, ale nie wolno mylić go z modelem Transit Custom.

### Transit VI (2000–2006)

To generacja, która mocno unowocześniła ofertę i była dostępna z napędem FWD oraz RWD, w zależności od wersji.
...
- 8-biegowy automat był już dostępny wcześniej; od 2024 rozszerzono cyfryzację oraz zaktualizowano ofertę napędów i systemów pokładowych
...
Kupując Transita VII (2006–2013), warto zwrócić szczególną uwagę na hałas z okolicy silnika oraz stan progów i nadkoli. Zaniedbany egzemplarz szybko niweczy oszczędność wynikającą z niskiej ceny zakupu.
{{% /info %}}

## Dane techniczne i wymiary Forda Transit

Wymiary dużego Forda Transit trzeba odczytywać ostrożnie, bo różnice między FWD i RWD nie kończą się na samym napędzie. Zmieniają się też wysokość podłogi, ładowność i dostępne konfiguracje DMC.
...
| **L4H3** | **3750 mm + zwis** | **6704 mm** | ok. **2780 mm** | ok. **4217 mm** | **2125 mm** | ok. **15,1 m³** | **3500 / 3900 / 4100 kg** | ok. **1100–1700 kg** w zależności od napędu i DMC | **1392 mm** | **1784 mm** |
...
Jeśli kupujesz Transita pod konkretną pracę, sam kod L/H nie wystarczy. Sprawdź jeszcze:
...
To podstawowy silnik współczesnego Transita. Występuje w kilku wariantach mocy i w zależności od wersji może współpracować z napędem FWD, RWD albo AWD.
...
- w nowszych rocznikach spotkasz także automat, w zależności od wersji i rynku
...
Zakup ma sens głównie wtedy, gdy auto ma potwierdzony serwis i dobry stan blacharski. Sama niższa cena zakupu nie wystarczy, jeśli po zakupie wyjdą wtryski, turbina i korozja.

{{% expert name="Marek Kowalczyk" %}}
Jeśli szukasz używanego Transita do zwykłej pracy kurierskiej, serwisowej albo pod lekką zabudowę, najbezpieczniej celować w 2.0 EcoBlue 130 KM z udokumentowanym serwisem. Sama moc nie załatwia sprawy – ważniejsze są stan wtryskiwaczy, DPF i to, czy auto nie było stale przeciążane.
{{% /expert %}}
...
To jeden z powodów, dla których Transit tak dobrze trzyma się w firmach. Ford daje szeroki wybór nadwozi, DMC i napędów, więc łatwiej dobrać bazę pod konkretną pracę niż próbować dopasować jedną uniwersalną wersję do wszystkiego.
...
| **Kombi / minibus** | **8 / 9 / 15 / 17** w zależności od rynku | różne długości i wysokości | wersje osobowe i pasażerskie | **3500–4600 kg** | przewóz pracowników i pasażerów |
...
| **Skrzynia / wywrotka** | w zależności od kabiny | zabudowa ok. **3,2–4,5 m** | najczęściej na bazie **RWD** | w zależności od wersji | budowlanka, komunalka, transport materiałów |
| **Kamper baza** | w zależności od projektu | najczęściej **L3H3 lub L4H3** | zabudowa turystyczna | **3500 kg** pod kat. B albo **3900+ kg** dla cięższych zabudów | kamper, vanlife, zabudowy wyprawowe |
...
- czujniki emisji: **300–2500 zł** w zależności od elementu
...
| **Volkswagen Crafter** | **102–177** | do **5,5 t** | **FWD / RWD / AWD** | **8-biegowy** | **e-Crafter** wycofany / ograniczony w zależności od rynku | do ok. **18,4 m³** |
...
- **Master** – pozostaje mocną propozycją w klasycznych wersjach dostawczych i pasażerskich, zwłaszcza tam, gdzie nie potrzebujesz AWD.

Jeśli patrzysz ściśle pod kątem użytkowym, Transit jest mocny tam, gdzie liczy się szeroki wybór konfiguracji, łatwa odsprzedaż i dobra dostępność wersji na rynku wtórnym. Jeśli priorytetem jest maksymalne DMC albo największa możliwa kubatura, konkurenci potrafią mieć przewagę w konkretnych zastosowaniach.
...
| **Mk8 2019–2020** | po liftingu | **75–115 tys. zł brutto** |
...
W praktyce najłatwiej kupić Transita z roczników **2017–2020**, bo to kompromis między ceną a wiekiem auta. Starsze egzemplarze są dużo tańsze, ale ryzyko wydatków po zakupie rośnie szybko, zwłaszcza gdy dochodzą korozja, zużycie osprzętu diesla i zaniedbany serwis.