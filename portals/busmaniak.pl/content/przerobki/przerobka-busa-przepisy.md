...
faq:
  ...
  - question: "Jakie elementy musi mieć kamper, żeby przejść badanie techniczne po zmianach konstrukcyjnych?"
    answer: "Obowiązkowe: miejsca do siedzenia ze stołem, miejsca do spania (mogą być tworzone z siedzeń), urządzenia kuchenne trwale zamontowane w pojeździe oraz szafki lub schowki do przechowywania bagażu i innych przedmiotów."
  - question: "Czy mogę jeździć przerobionym busem bez przerejestrowania?"
    answer: "Technicznie tak – bus z zabudową kamperową bez zmiany dokumentów nadal jest zarejestrowany jako dostawczy (N1). Nie korzystasz jednak z korzyści: niższego OC/AC, ewentualnych ulg w opłatach drogowych dla cięższych pojazdów ani klasyfikacji kempingowej na kempingach. Przy kontroli drogowej brak zgodności stanu faktycznego z dowodem rejestracyjnym może skutkować zatrzymaniem dowodu."
---
...
| Akt prawny | Co reguluje | Znaczenie dla przerabiającego |
|------------|-------------|-------------------------|
...
| Regulamin EKG ONZ nr 17 | Wytrzymałość siedzeń i ich mocowań | Wymogi dla siedzeń obrotowych i dodatkowych |

### Klasyfikacja pojazdu – N1 vs M1

Bus dostawczy jest rejestrowany jako N1 (pojazd ciężarowy do 3,5 t). Po przeróbce na kampera zmienia kategorię na M1 specjalny – samochód kempingowy. Ta zmiana pociąga za sobą konkretne konsekwencje podatkowe, ubezpieczeniowe i użytkowe.

## Wymagania techniczne dla kampera {#wymagania}

Stacja kontroli pojazdów sprawdza obecność i prawidłowy montaż obowiązkowych elementów zabudowy. Brak któregokolwiek z nich oznacza odmowę wydania pozytywnego zaświadczenia.

### Obowiązkowe elementy zabudowy

- **Miejsce do spania** – przepisy nie określają minimalnych wymiarów. Miejsce do spania może powstawać np. przez rozłożenie siedzeń, musi jednak stanowić integralną część pojazdu.
- **Stół z miejscami do siedzenia** – wystarczy stół składany do ściany lub oparty na jednej nodze, z miejscami dla 2 osób. Musi być funkcjonalny – sam blat bez możliwości siedzenia nie spełnia wymogu.
...
Cała procedura składa się z kilku etapów i trwa od kilku dni do kilku tygodni – w zależności od dostępności terminów w stacji diagnostycznej i sprawności działania wydziału komunikacji.

### Etap 1 – przygotowanie zabudowy

Przed wizytą w stacji kontroli pojazdów upewnij się, że zabudowa jest kompletna i funkcjonalna. Wszystkie elementy (łóżko, stół, kuchnia, szafki, oświetlenie, [instalacja wodna](/przerobki/instalacja-wodna-kamper/)) muszą działać – diagnosta sprawdza nie tylko obecność, lecz także funkcjonalność.

### Etap 2 – badanie techniczne w OSKP

Okręgowa stacja kontroli pojazdów (OSKP) przeprowadza badanie techniczne pojazdu po przebudowie. Na badanie należy zabrać oświadczenie firmy (z odpowiednim kodem PKD), która dokonała zmian. Diagnosta sprawdza:
...
Podstawowym dokumentem wymaganym na badaniu technicznym jest oświadczenie przedsiębiorcy, który dokonał zmian (działalność z PKD 45.20.Z), że zostały one wykonane zgodnie z przepisami. W rzadkich przypadkach, na prośbę diagnosty, może być wymagana dodatkowa opinia rzeczoznawcy samochodowego potwierdzająca prawidłowość zmian.

### Etap 4 – zmiana w wydziale komunikacji

Z kompletem dokumentów – oświadczeniem warsztatu, zaświadczeniem o pozytywnym wyniku badania technicznego i potwierdzeniem zapłaty podatku akcyzowego z urzędu skarbowego – udajesz się do wydziału komunikacji. Tam następuje zmiana adnotacji w dowodzie rejestracyjnym, a pojazd otrzymuje klasyfikację „samochód specjalny – kempingowy” (M1).

## Koszty przerejestrowania w 2026 roku {#koszty}

Największym jednorazowym kosztem związanym ze zmianą przeznaczenia pojazdu jest podatek akcyzowy. Należy go zgłosić w urzędzie skarbowym na formularzu AKC-U/S w ciągu 14 dni od daty wystawienia oświadczenia o zmianach. Stawki wynoszą 3,1% dla pojazdów z silnikiem do 2000 cm³ i 18,6% dla pojazdów z silnikiem powyżej 2000 cm³ – od średniej wartości rynkowej pojazdu.
...
Firmy oferujące „kompleksową obsługę procedury” doliczają własną opłatę do kosztów urzędowych. Jedyną realną wartością jest często zapewnienie oświadczenia od zaprzyjaźnionego warsztatu. Jeśli zabudowa spełnia wymagania, a wykonawca może wystawić wymagany dokument, samodzielne przejście procedury jest proste i wymaga dwóch wizyt (OSKP, wydział komunikacji).
{{% /info %}}

## Zmiany w przepisach 2024–2026 {#zmiany-przepisow}

Przepisy dotyczące zmian konstrukcyjnych przy przeróbce na kampery są stabilne. Najważniejsze nowelizacje wpływające na osoby budujące kampery w 2026 roku:
...
- **Korzystniejsze opłaty drogowe dla pojazdów > 3,5 t** – w Niemczech i Austrii kampery (M1) o DMC powyżej 3,5 t są często zwolnione z myta dla ciężarówek (Maut/Go-Box) i podlegają systemowi winiet, co jest znacznie tańsze.
- **Parking na kempingach** – wiele kempingów wymaga klasyfikacji kempingowej do wjazdu. Wjazd busem dostawczym bywa odmawiany.
- **Brak ograniczeń prędkości przewidzianych dla pojazdów ciężarowych** – w niektórych krajach busy N1 mają niższe limity prędkości na autostradach niż pojazdy osobowe M1.
- **Możliwość uzyskania zwrotu składki OC/AC** – właściciel ma obowiązek niezwłocznie zgłosić zmianę klasyfikacji ubezpieczycielowi. Ze względu na niższą szkodowość kamperów często skutkuje to ponownym przeliczeniem składki i zwrotem jej części, a także pozwala uniknąć problemów przy likwidacji szkody.

Znajomość przepisów i prawidłowe przygotowanie zabudowy to fundament udanego projektu [kampera samoróbki](/przerobki/kampery-samorobki/). Zaplanuj [zabudowę](/przerobki/fiat-ducato-kamper/) z uwzględnieniem wymagań technicznych od pierwszego dnia – dostosowywanie gotowego wnętrza pod badanie techniczne kosztuje czas i nerwy. Szczegółowy [kosztorys budowy kampera](/przerobki/budowa-kampera-koszty/) uwzględnia pozycję przerejestrowania na końcu każdego wariantu budżetowego.