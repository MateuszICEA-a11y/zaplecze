...
faq:
  - question: "Czy do wynajmu kampera potrzebuję specjalnego prawa jazdy?"
    answer: "Nie. Większość kamperów w polskich wypożyczalniach ma DMC do 3,5 tony, więc wystarczy standardowe prawo jazdy kategorii B. Tylko cięższe pojazdy (niektóre integry i alkowy powyżej 3,5 t) wymagają kategorii C1."
  - question: "Ile wynosi kaucja za wynajem kampera?"
    answer: "Standardowa kaucja to 3000–6000 zł, wpłacana gotówką lub przelewem w dniu odbioru. Za ok. 300 zł można wykupić ubezpieczenie kaucji, które chroni przed jej utratą w razie drobnych uszkodzeń."
...
- **Umowa najmu** – reguluje okres, cenę, limit km, zasady użytkowania i odpowiedzialność za szkody
- **Protokół zdawczo-odbiorczy** – spisywany przy odbiorze i zwrocie, dokumentuje stan pojazdu
- **Regulamin wypożyczalni** – zawiera szczegółowe zasady (zakaz palenia, zwierzęta, drogi gruntowe)
...
- **Instalacja gazowa** – jak włączyć butlę, gdzie jest zawór odcinający, jak działa kuchenka i ogrzewanie Truma/Webasto
- **Instalacja wodna** – napełnianie zbiornika świeżej wody, opróżnianie zbiornika szarej wody, obsługa pompy
- **Instalacja elektryczna** – podłączanie do prądu 230V na kempingu, ładowanie akumulatora pomocniczego, panel sterowania
- **Toaleta kasetowa** – wyjmowanie kasetki, opróżnianie, dozowanie płynu chemicznego
- **Markiza** – rozkładanie, zabezpieczanie przed wiatrem, składanie
...
**Opróżnij zbiorniki.** Przed zwrotem opróżnij kasetkę WC i zbiornik szarej wody. Wiele wypożyczalni nalicza 100–200 zł za nieopróżnione zbiorniki.
