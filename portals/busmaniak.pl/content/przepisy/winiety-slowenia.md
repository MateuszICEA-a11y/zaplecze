...
faq:
  ...
  - question: "Czy mogę kupić słoweńską e-winietę w Polsce?"
    answer: "Tak, przez oficjalny sklep evinjeta.dars.si lub polskie serwisy pośredniczące, takie jak autopay.eu. Winieta aktywuje się od daty, którą sam wybierzesz przy zakupie."
...
Słowenia zrezygnowała z winiet naklejanych na szybę w lutym 2022 roku. Od tego momentu działa system [e-winieta](https://en.wikipedia.org/wiki/Motorways_in_Slovenia) (słow. e-vinjeta) zarządzany przez spółkę DARS. Cała procedura opiera się na numerze rejestracyjnym – nie dostajesz żadnego urządzenia ani naklejki.

Przy zakupie podajesz numer tablicy, kraj rejestracji i kategorię pojazdu. Kamery na autostradach i drogach ekspresowych automatycznie odczytują tablice i weryfikują ważność winiety. System działa przez całą dobę, bez bramek i bez zatrzymywania ruchu.
...
Słowenia dzieli pojazdy do 3,5 t na dwie kategorie w zależności od wysokości nadwozia mierzonej nad pierwszą osią. To kluczowe rozróżnienie dla kierowców busów – większość dostawczaków trafia do droższej kategorii 2B.
...
Ważna informacja dla kierowców ciągnących przyczepy: pojazdy z DMC do 3,5 tony nie potrzebują dodatkowej winiety na przyczepę. Zasada ta obowiązuje nawet wtedy, gdy dopuszczalna masa całkowita całego zestawu przekracza 3,5 tony.
...
Najwygodniej kupisz ją w oficjalnym sklepie DARS pod adresem evinjeta.dars.si. Serwis ma polską wersję językową. Płacisz kartą, a potwierdzenie przychodzi na e-mail w ciągu kilku minut.
...
- **Liczba osi pojazdu** – 2, 3 lub więcej
- **Klasa emisji spalin** – od Euro 0 do Euro 6
- **Przejechany dystans** – opłata naliczana za kilometr

Orientacyjny koszt przejazdu busa 2-osiowego Euro 6 z Mariboru do Lublany (ok. 125 km) to około 20 EUR. Przy starszej klasie emisji Euro 4 zapłacisz około 25 EUR za tę samą trasę.

![Słoweńska autostrada z widokiem na Alpy Julijskie](/images/winiety-slowenia-hero.webp)

## Drogi objęte winietą w Słowenii

Sieć autostrad i dróg ekspresowych w Słowenii liczy około 620 km. Winieta obowiązuje na wszystkich odcinkach zarządzanych przez DARS.
...
Drogi regionalne, lokalne i miejskie są bezpłatne. Jeśli chcesz ominąć opłaty, możesz korzystać z dróg drugorzędnych – ale w górskim terenie Słowenii trasa wydłuża się znacznie.
...
System kamer ANPR (Automatic Number Plate Recognition) kontroluje tablice rejestracyjne na wszystkich odcinkach płatnych. Nie ma bramek ani kontroli manualnych – weryfikacja jest w pełni automatyczna.
...
- **Winieta wygasła** – nawet o jeden dzień
- **Błędna kategoria** – kupiono winietę 2A zamiast 2B dla busa powyżej 1,3 m
- **Zły numer rejestracyjny** – literówka przy zakupie online

Po otrzymaniu mandatu masz prawo wnieść odwołanie, ale w praktyce słoweński system jest precyzyjny i rzadko zdarzają się błędy techniczne. Sprawdź poprawność danych na potwierdzeniu zakupu jeszcze przed wjazdem na autostradę.

## Trasa przez Słowenię do Chorwacji – porady dla busiarzy

Słowenia to najczęstszy kraj tranzytowy na drodze z Polski do chorwackiego wybrzeża. Klasyczna trasa prowadzi z [Austrii](/przepisy/winieta-austria/) przez tunel Karawanki, autostradą A2 przez Lublanę do przejścia granicznego Obrežje–Bregana.
...
- **Parkingi autostradowe** – zadbane, z toaletami i restauracjami, nadają się na nocleg (choć formalnie biwakowanie na parkingach jest zabronione)
