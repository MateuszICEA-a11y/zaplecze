...
faq:
  - question: "Jakim busem mogę jeździć na prawo jazdy kategorii B?"
    answer: "Na kat. B możesz jeździć busem o DMC do 3500 kg przewożącym do 9 osób łącznie z kierowcą. Obejmuje to m.in. Fiata Ducato, Mercedesa Sprintera, VW Craftera i Transita w wersjach do 3,5 t."
  - question: "Czy na kat. B mogę ciągnąć przyczepę busem?"
    answer: "Tak. Na kat. B holowanie przyczepy o DMC do 750 kg jest dozwolone bez dodatkowych uprawnień. Przy cięższej przyczepie suma DMC zestawu nie może przekroczyć 3500 kg. Dla zestawów 3500–4250 kg potrzebujesz kodu 96."
  ...
  - question: "Czy na kat. B mogę prowadzić busa elektrycznego powyżej 3,5 t?"
    answer: "Tak, od grudnia 2021 roku posiadacze kat. B z co najmniej 2-letnim stażem mogą prowadzić pojazdy na paliwa alternatywne o DMC do 4250 kg, jeśli przekroczenie 3500 kg wynika z masy baterii."
sources:
...
Dla właścicieli busów ta definicja oznacza dwa nieprzekraczalne limity. Pierwszy to DMC – 3,5 tony obejmuje masę własną pojazdu wraz z kierowcą, pasażerami, ładunkiem i paliwem. Drugi to liczba miejsc siedzących – maksymalnie 8 pasażerów plus kierowca. Przekroczenie któregokolwiek z nich oznacza jazdę bez uprawnień.
...
- **Badanie lekarskie** – uzyskanie zaświadczenia o braku przeciwwskazań do kierowania pojazdami.
...
| Model | DMC (t) | Liczba miejsc | Ładowność (kg) |
| :--- | :--- | :--- | :--- |
| [Fiat Ducato](/modele/fiat-ducato/) furgon 35 | 3,5 | 3 (furgon) / 9 (kombi) | 1100–1450 |
| Mercedes Sprinter 314/316 | 3,5 | 3 / 9 | 900–1400 |
| VW Crafter 35 | 3,5 | 3 / 9 | 1000–1350 |
| Ford Transit 350 | 3,5 | 3 / 9 | 1100–1400 |
| Renault Master 33/35 | 3,3–3,5 | 3 / 9 | 1000–1350 |
| Peugeot Boxer 35 | 3,5 | 3 / 9 | 1100–1400 |

Oznaczenia liczbowe w nazwach modeli często odnoszą się do DMC: Ducato „35” to 3500 kg, a Master „33” to 3300 kg. Zawsze należy jednak sprawdzić wartość w polu F.2 dowodu rejestracyjnego, ponieważ DMC zależy od konkretnej konfiguracji pojazdu.
...
Lżejsze vany dają większy zapas masy przy holowaniu przyczepy w ramach limitu 3500 kg dla całego zespołu pojazdów.

![Prawo jazdy kategorii B i bus dostawczy](/images/prawo-jazdy-kategoria-b-hero.webp)

## Kategoria B z przyczepą – zasady holowania

Posiadacz prawa jazdy kategorii B może holować przyczepę za busem, musi jednak przestrzegać ścisłych limitów wagowych. Zasady te zależą od dopuszczalnej masy całkowitej (DMC) przyczepy.

### Przyczepa do 750 kg DMC

Możesz holować tzw. przyczepę lekką (o DMC do 750 kg) bez żadnych dodatkowych uprawnień. Co istotne, w tym przypadku suma DMC busa i przyczepy może przekroczyć 3,5 tony. Oznacza to, że legalny jest zespół złożony z busa o DMC 3,5 t i przyczepy o DMC 750 kg (łącznie 4250 kg).
...
Kierowcę busa z przyczepą obowiązują również niższe limity prędkości. Na drogach jednojezdniowych poza obszarem zabudowanym limit wynosi 70 km/h, a na autostradach, drogach ekspresowych i dwujezdniowych – 80 km/h.

### Przyczepa powyżej 750 kg DMC

W przypadku holowania przyczepy o DMC powyżej 750 kg na samej kategorii B obowiązuje zasada, że suma DMC pojazdu i przyczepy nie może przekroczyć 3500 kg. W praktyce oznacza to, że busem o DMC 3,5 t nie pociągniemy przyczepy innej niż lekka.

{{% info title="Kod 96 – rozszerzenie uprawnień" icon="info" %}}
Kod 96 podnosi limit DMC zespołu pojazdów do 4250 kg. Aby go uzyskać, wystarczy zdać państwowy egzamin praktyczny w WORD – nie jest wymagane żadne dodatkowe szkolenie. Koszt egzaminu to 170 zł. Kod 96 nie jest osobną kategorią, lecz jedynie rozszerzeniem uprawnień kat. B, odnotowanym w dokumencie.
{{% /info %}}

Dla kierowców busów o DMC 3,5 t kod 96 jest w praktyce mało użyteczny. Pozwala on na zespół 4250 kg, co oznacza, że do 3,5-tonowego pojazdu można dołączyć przyczepę o DMC zaledwie 750 kg – a to jest już legalne na samej kategorii B. Pełne możliwości daje dopiero kategoria B+E, która uprawnia do prowadzenia zespołu pojazdów o DMC do 7000 kg (np. bus 3,5 t + przyczepa 3,5 t).

## Kiedy potrzebujesz kategorii C1 lub C

Prawo jazdy kategorii B ma dwa nieprzekraczalne limity: 3500 kg dopuszczalnej masy całkowitej oraz 9 osób w pojeździe. Przekroczenie któregokolwiek z nich wymaga zdobycia wyższych uprawnień.
...
Jeśli pojazd jest fabrycznie przeznaczony do przewozu więcej niż 9 osób (łącznie z kierowcą), wymagana jest kategoria D1 (do 17 osób) lub D (powyżej 17 osób). Dotyczy to minibusów, takich jak Mercedes Sprinter City czy specjalistyczne wersje Iveco Daily.

## Kategoria B a kampery

Większość kamperów dostępnych na rynku mieści się w limicie 3,5 tony, co czyni je dostępnymi dla posiadaczy prawa jazdy kategorii B. Kluczowym problemem użytkowników jest jednak niska ładowność.

### Kampery do 3,5 t na kat. B

Standardowy kamper na bazie Fiata Ducato czy Mercedesa Sprintera jest legalny na kategorię B. Należy jednak pamiętać, że sama zabudowa kempingowa waży od 300 do 600 kg, a do masy pojazdu trzeba doliczyć pasażerów, wodę, bagaże i wyposażenie. Rzeczywista ładowność często wynosi zaledwie 200–500 kg.
...
Wbrew powszechnym mitom zmiana od 1 lipca 2026 roku nie dotyczy busów z przyczepą – zespoły pojazdów o DMC powyżej 3,5 t w międzynarodowym transporcie zarobkowym są objęte obowiązkiem tachografu od dawna. Nowe przepisy Pakietu Mobilności obniżają próg dla pojazdów wykorzystywanych do międzynarodowego przewozu drogowego rzeczy.
