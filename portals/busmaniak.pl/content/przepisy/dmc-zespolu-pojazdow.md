...
### Gdzie znaleźć DMC zespołu w dokumentach

Kluczowe pola w dowodzie rejestracyjnym pojazdu ciągnącego:

| Pole | Znaczenie |
| :--- | :--- |
| F.2 | DMC pojazdu ciągnącego (busa) |
| F.3 | DMC zespołu pojazdów (bus + przyczepa) |
| G | Masa własna pojazdu |
| O.1 | Maksymalna masa przyczepy z hamulcem |
| O.2 | Maksymalna masa przyczepy bez hamulca |

Pola O.1 i O.2 określają, jak ciężką przyczepę bus może holować. Jeśli O.1 wynosi 2000 kg, a DMC przyczepy to 2500 kg – nie możesz jej legalnie podczepić, nawet jeśli suma mas mieściłaby się w limicie F.3.

## Jak obliczyć DMC zespołu – bus z przyczepą

Obliczenie DMC zespołu pojazdów wymaga porównania dwóch wartości. Pierwsza to suma DMC busa (F.2) i DMC przyczepy (F.2). Druga to wartość F.3 z dowodu rejestracyjnego busa. Obowiązuje zawsze niższa z nich.
...
3. Obowiązuje niższa wartość: 4250 kg
