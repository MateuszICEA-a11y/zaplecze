...
faq:
  - question: "Ile kosztuje homologacja kampera w 2026 roku?"
    answer: "Sama procedura administracyjna kosztuje 400-1500 zł (badanie OSKP ok. 180 zł, opłata w Wydziale Komunikacji ok. 80 zł, oświadczenie firmy 200-500 zł, ewentualna opinia rzeczoznawcy 300-500 zł). Do tego dochodzi akcyza 3,1% (silnik do 2.0) lub 18,6% (powyżej 2.0) od wartości rynkowej pojazdu."
  - question: "Jakie wyposażenie musi mieć bus, żeby przejść homologację kampera?"
    answer: "Bus musi mieć na stałe zamontowane: miejsca do siedzenia, stół, miejsca do spania, sprzęt kuchenny do gotowania oraz szafki lub schowki na bagaż. Toaleta i łazienka nie są wymagane, a przepisy nie precyzują minimalnych wymiarów łóżka."
  - question: "Czy mogę sam przerobić busa na kampera i go zalegalizować?"
    answer: "Przeróbkę możesz wykonać samodzielnie, ale oświadczenie o zmianach konstrukcyjnych musi wystawić firma z odpowiednim kodem PKD (45.20.Z). Bez tego dokumentu Okręgowa Stacja Kontroli Pojazdów nie przeprowadzi badania."
  - question: "Jakie korzyści daje rejestracja busa jako kampera?"
    answer: "Główną korzyścią jest niższe ubezpieczenie OC (nawet o 30-40%). Rejestracja jako pojazd M1 pozwala też ominąć lokalne zakazy tonażowe dla aut ciężarowych (kategorii N). Nie zwalnia jednak z opłat e-TOLL dla pojazdów >3,5 t ani nie gwarantuje wjazdu do Stref Czystego Transportu."
---
...
Wbrew powszechnemu przekonaniu polskie przepisy nie wymagają łazienki ani toalety w kamperze. Pojazd przejdzie homologację bez prysznica, WC chemicznego czy zbiornika na ścieki. To elementy komfortu, a nie wymogi prawne.
{{% /info %}}
...
Inspiracje i poradniki dotyczące [przeróbek busów](/przerobki/) znajdziesz w osobnej sekcji. Jeśli interesuje Cię konkretny model, sprawdź [przewodnik po przeróbce Fiata Ducato na kampera](/przerobki/fiat-ducato-kamper/).
