...
faq:
  ...
  - question: "Czy mogę podwyższyć DMC kampera?"
    answer: "Tak, jeśli konstrukcja podwozia na to pozwala. Wymaga to opinii uprawnionego rzeczoznawcy samochodowego, badania technicznego w OSKP i wymiany dowodu rejestracyjnego. Koszt to 1500–5000 zł."
...
Dane o masach znajdziesz w dowodzie rejestracyjnym. Kody literowe są ujednolicone w całej Unii Europejskiej, co ułatwia interpretację dokumentów z różnych krajów.

Pola F.1 i F.2 często mają identyczną wartość, ale przy autach sprowadzanych z zagranicy mogą się różnić. Wartość w polu F.2 jest wiążąca dla polskich służb kontrolnych.

| Kod | Znaczenie |
| :--- | :--- |
| F.1 | Maksymalna masa całkowita technicznie dopuszczalna |
| F.2 | Dopuszczalna masa całkowita – wartość wiążąca w Polsce |
| F.3 | DMC zespołu pojazdów (auto + przyczepa) |
| G | Masa własna pojazdu |

Jeśli chcesz dokładnie wiedzieć, co oznaczają poszczególne rubryki, [szczegółowy opis pól dowodu rejestracyjnego](/przepisy/dmc-pojazdu/) znajdziesz w osobnym artykule.
...
Ładowność określa, ile kilogramów możesz legalnie zabrać na pokład. To nie tylko towar na pace – liczą się też pasażerowie, ich bagaże, a nawet ciężki sprzęt zamontowany po zakupie auta.

Przy planowaniu zabudowy kamperowej lub długiej wyprawy z pełnym załadunkiem skorzystaj z [kalkulatora DMC](/narzedzia/kalkulator-dmc/), który pokaże Ci dokładnie, ile rezerwy Ci zostaje.
...
### Przykłady dla popularnych busów

Poniżej orientacyjne zakresy mas dla trzech najpopularniejszych furgonów w wersjach o DMC 3,5 tony. Konkretna wartość zależy od rozstawu osi (L1–L4), wysokości dachu (H1–H3) i silnika.

| Model | Masa własna (kg) | Ładowność (kg) |
| :--- | :--- | :--- |
| [Fiat Ducato](/modele/fiat-ducato/) furgon | 2050–2400 | 1100–1450 |
| Mercedes Sprinter III furgon | 2100–2600 | 900–1400 |
| VW Crafter furgon | 2150–2500 | 1000–1350 |

Różnice sięgają 500 kg między konfiguracjami tego samego modelu. Wybierając bazę pod kampera, szukaj wersji z najniższą masą własną – zyskasz dodatkowe kilogramy na meble i instalacje.
...
Pojazdy o DMC od 3,5 do 7,5 tony wymagają kategorii C1. Dotyczy to ciężkich kamperów zintegrowanych oraz dużych dostawczaków – np. Iveco Daily 70C w wersji 7-tonowej.

Prowadzenie wiąże się z dodatkowymi kosztami: wyższe opłaty drogowe (e-TOLL), obowiązek tachografu w transporcie komercyjnym i ograniczenia wjazdu do centrów wielu miast.

### Powyżej 7,5 tony – kat. C

Pełna kategoria C jest wymagana dla pojazdów powyżej 7,5 tony. W świecie kamperów to pojazdy budowane na podwoziach ciężarowych – MAN TGM, Mercedes Atego czy Iveco Eurocargo. Ładowność przestaje być problemem, ale koszty eksploatacji i winiet rosną kilkukrotnie.

## Przekroczenie DMC – konsekwencje prawne
...
Budowa kampera to walka o każdy kilogram. Lekki furgon po dodaniu izolacji, zbiorników z wodą, paneli fotowoltaicznych i mebli traci kilkaset kilogramów ładowności. Na pasażerów i bagaże zostaje czasem zaledwie 100–200 kg.

Planujesz holowanie przyczepki za kamperem? Sprawdź [DMC przyczepy](/przepisy/dmc-przyczepy/) – łączna masa zestawu może wymagać kodu B96 lub kategorii B+E.
...
### Podwyższenie DMC – czy to możliwe

Fiat Ducato, Mercedes Sprinter czy VW Crafter często występują w wersjach o konstrukcyjnej wytrzymałości do 4250 kg lub 5000 kg, mimo że w dowodzie widnieje 3500 kg.

Procedura podwyższenia DMC wymaga kilku kroków:

- **Zaświadczenie od producenta** – potwierdzenie technicznej możliwości zmiany
- **Badanie w OSKP** – Okręgowa Stacja Kontroli Pojazdów weryfikuje stan techniczny
- **Opinia uprawnionego rzeczoznawcy samochodowego** – ocena zmian konstrukcyjnych
