...
faq:
  ...
  - question: "Czy warto importować kampera z Niemiec?"
    answer: "Import z Niemiec daje oszczędność 15-30% w porównaniu z cenami w Polsce. Trzeba jednak doliczyć akcyzę (3,1-18,6% wartości), badanie techniczne, tłumaczenia dokumentów i rejestrację – łącznie 10 000-25 000 zł dodatkowych kosztów."
  - question: "Jaki przebieg kampera jest akceptowalny?"
    answer: "Prywatne kampery przejeżdżają średnio 5-10 tys. km rocznie. Przebiegi rzędu 15-30 tys. km rocznie są charakterystyczne dla aut wycofanych z wypożyczalni (tzw. ex-rental). Przebieg do 100 tys. km oznacza stan idealny, 150-250 tys. km jest akceptowalny po weryfikacji serwisowej, a powyżej 300 tys. km rośnie ryzyko kosztownych awarii."
  ...
  - question: "Czy importowany kamper wymaga homologacji?"
    answer: "Kamper z UE z ważnym dowodem rejestracyjnym i certyfikatem CoC nie wymaga osobnej homologacji – wystarczy badanie techniczne w Polsce i rejestracja w wydziale komunikacji. Homologacja indywidualna dotyczy pojazdów spoza UE lub pojazdów przerabianych."
sources:
  - "Wikipedia"
  - "Otomoto.pl"
  - "truck1-pl.com"
...
Otomoto to największa baza ofert **używanych kamperów** z precyzyjnymi filtrami, co ułatwia selekcję. Weryfikacja sprzedawcy zapewnia tu minimum bezpieczeństwa. OLX to bardziej lokalna tablica ogłoszeń – znajdziesz tam okazje od osób prywatnych, ale wiąże się to z większym ryzykiem. Pamiętaj, że obie platformy to tylko punkt wyjścia, bo ciekawe [kampery na sprzedaż](/kampery/kampery-na-sprzedaz/) oferują też dealerzy.

### Dealerzy kamperów

Zakup u dealera (np. Elcamp, Caravaning Mikołajczyk, ACK Kampery) to opcja dla tych, którzy cenią sobie spokój. Pojazdy są zazwyczaj po przeglądzie, często z 6- lub 12-miesięczną gwarancją. Zapłacisz **10–20%** więcej niż u osoby prywatnej, ale w zamian dostajesz pełną historię serwisową i bezpieczeństwo transakcji. Dodatkowo wielu dealerów przyjmuje starszy pojazd w rozliczeniu.

### Import z Niemiec, Francji i Włoch

Niemiecki rynek **używanych kamperów** jest ogromny – ofert jest wielokrotnie więcej, a ceny przed importem bywają niższe o **15–30%**. Szukając we Francji lub we Włoszech, zyskujesz dodatkowy atut: łagodniejszy klimat to mniejsze ryzyko skorodowanego podwozia. Większość kamperów przekracza standardowe gabaryty, dlatego transport na lawecie niskopodwoziowej z Niemiec to realny koszt **4000–7000 zł**. Tańszą alternatywą może być powrót na kołach z wykorzystaniem niemieckich tablic wywozowych.
...
Wilgoć to wróg numer jeden każdego kampera. Uzbrój się w wilgotnościomierz i sprawdzaj narożniki, szafki, przestrzeń pod materacami i okolice okien – odczyt powyżej 20% to sygnał ostrzegawczy. Szukaj też oznak problemu: zapachu stęchlizny, odbarwień czy spuchniętych płyt meblowych. W alkowach newralgicznym punktem jest połączenie z dachem, a w [półzintegrowanych](/kampery/samochody-kempingowe/) – połączenie kabiny z zabudową.

Bądź czujny na próby maskowania problemu. Jeśli w kamperze unosi się intensywny, chemiczny zapach ozonu lub wyjątkowo mocnej „choinki waniliowej”, to sygnał alarmowy. Nieuczciwi sprzedawcy często próbują w ten sposób zamaskować odór stęchlizny, który wydobywa się ze zgniłej, drewnianej konstrukcji ścian, zwłaszcza w upalne dni.

### Korozja podwozia i ramy

W kilkunastoletnich kamperach na bazie Ducato czy Sprintera bez regularnej konserwacji rdza jest niemal pewna. Połóż się pod auto i dokładnie obejrzyj podłużnice, progi, mocowania zabudowy do ramy oraz okolice zbiorników. Perforacja lub rdza wgłębna na elementach nośnych to argument za natychmiastowym zakończeniem oględzin.
...
- **Elektryczna:** Sprawdź stan obu akumulatorów, działanie panelu sterowania oraz wszystkich gniazd 12V i 230V. Po latach luźne styki czy zaśniedziałe połączenia to norma.
...
Kampery jeżdżą znacznie mniej niż busy dostawcze – średnio **15–20 tys. km** rocznie wobec **40–60 tys. km** w transporcie. Dlatego przebieg kampera oceniasz inaczej niż w dostawczaku.
...
## Ceny używanych kamperów według rocznika i typu
...
Alkowce są tańsze od profilowanych mimo większej przestrzeni – popyt na nie spada ze względu na wyższy profil nadwozia i większe spalanie. [Tanie kampery](/kampery/tanie-kampery/) w segmencie do 50 000 zł to najczęściej alkowce i kampervany po 15 latach eksploatacji.
...
## Import a Polska – różnice w stanie i cenie
...
### Różnice cenowe w zależności od kraju

Na niemieckim rynku ceny bywają niższe o **15–30%** w porównaniu z Polską. Z kolei we Włoszech (królestwie marek Rimor, Laika, Roller Team) oszczędności sięgają **10–20%**, a cieplejszy klimat sprzyja lepszemu stanowi blacharki. Francuskie marki (Chausson, Pilote) plasują się pośrodku, oferując solidny stosunek jakości do ceny.

### Ukryte koszty importu

Do ceny zakupu musisz doliczyć cały pakiet kosztów dodatkowych. Na liście są transport (**4000–7000 zł**), [podatek akcyzowy](https://pl.wikipedia.org/wiki/Podatek_akcyzowy) (**3,1%** lub **18,6%** wartości, w zależności od pojemności silnika), badanie techniczne, tłumaczenia i opłaty rejestracyjne. W sumie import uszczupli Twój portfel o dodatkowe **10 000–25 000 zł**.

### Stan techniczny – na co zwrócić uwagę przy imporcie

Niemieckie kampery często kuszą pełną dokumentacją serwisową (TÜV, książka serwisowa), ale uważaj na korozję w starszych modelach – tamtejsze zimy nie oszczędzają podwozi. Z kolei we Włoszech czy Hiszpanii rdza jest mniejszym problemem, ale dokumentacja bywa niekompletna. Niezależnie od kraju zawsze staraj się zweryfikować historię pojazdu w lokalnych bazach danych.

{{% youtube %}}

## Homologacja importowanego kampera

Procedura rejestracji zależy od tego, skąd pochodzi pojazd i czy ma fabryczną zabudowę kamperową. Pamiętaj też, że od lipca 2022 roku obowiązują zaostrzone przepisy akcyzowe. Każda zmiana przeznaczenia pojazdu, np. rejestracja furgonu jako kampera, rodzi obowiązek zapłaty akcyzy według takich samych stawek jak przy imporcie.

### Kamper z UE z certyfikatem CoC

Najprostszy scenariusz to import fabrycznego kampera z kraju UE z kompletem dokumentów, w tym z certyfikatem zgodności (CoC). Procedura sprowadza się do tłumaczeń, badania technicznego w Polsce i wizyty w wydziale komunikacji – całość zajmuje 2–4 tygodnie i kosztuje **500–1000 zł** (bez akcyzy). Zupełnie inaczej wygląda sytuacja, gdy planujesz samodzielną [budowę kampera od podstaw](/przerobki/budowa-kampera-krok-po-kroku/), co wymaga homologacji indywidualnej.

### Przerobiony bus bez homologacji kamperowej

Kupno busa przerobionego na kampera, ale zarejestrowanego jako furgon, oznacza konieczność [zmiany kwalifikacji pojazdu](/przepisy/homologacja-kampera/). Proces wymaga opinii rzeczoznawcy, a pojazd musi spełniać określone warunki, m.in. mieć stałe miejsce do spania i gotowania, a także okna i wentylację. Po badaniu technicznym w OSKP i złożeniu deklaracji AKC-U/S w urzędzie skarbowym auto zostanie zarejestrowane jako „specjalny kempingowy”. Do kosztów operacyjnych (3000–6000 zł) należy doliczyć akcyzę, której stawka wynosi 3,1% (<2000 cm³) lub 18,6% (>2000 cm³) wartości rynkowej pojazdu.