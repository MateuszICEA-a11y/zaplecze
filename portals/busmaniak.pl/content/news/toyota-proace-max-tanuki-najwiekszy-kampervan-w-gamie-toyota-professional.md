...
h1: Toyota Proace Max Tanuki – największy kampervan w gamie Toyota Professional
toc: false
main_keyword: Toyota Proace Max Tanuki
lead: Toyota Professional wchodzi mocniej w segment rekreacyjny i pokazuje największego kampervana w swojej ofercie. Proace Max Tanuki ma łączyć bazę dużego vana z pełniejszą zabudową turystyczną dla osób szukających więcej przestrzeni w podróży.
categories:
- news
tags:
- toyota
...
## Więcej miejsca i pełniejsza zabudowa

Najważniejszym atutem nowego modelu ma być przestrzeń. Sama baza Proace Max daje znacznie większe możliwości aranżacji wnętrza niż mniejsze auta z rodziny Proace, co przekłada się na wygodniejsze strefy spania, przechowywania i codziennego funkcjonowania podczas postoju.
