---
title: Góra kory w Iveco Daily. ITD zatrzymała busa przeładowanego aż czterokrotnie
date: 2026-04-03
description: Inspektorzy ITD zatrzymali Iveco Daily przewożące korę. Bus był przeładowany aż czterokrotnie względem dopuszczalnej ładowności.
draft: false
author: Redakcja BusManiak.pl
h1: Góra kory w Iveco Daily! Czterokrotnie przeładowany bus zatrzymany przez ITD
toc: false
main_keyword: Iveco Daily przeładowany
lead: Niebezpiecznie załadowane Iveco Daily zwróciło uwagę inspektorów ITD ogromną ilością przewożonej kory. Kontrola potwierdziła skrajne przeciążenie pojazdu, które mogło mieć poważne konsekwencje dla bezpieczeństwa na drodze.
categories:
- news
tags:
- iveco daily
...
## ITD zatrzymała Iveco Daily z ogromnym ładunkiem kory

Inspektorzy Inspekcji Transportu Drogowego zatrzymali do kontroli Iveco Daily, którego stan załadunku od razu wzbudził podejrzenia. Na pojeździe przewożono dużą ilość kory, ułożonej wysoko ponad zabudową, co już na pierwszy rzut oka sugerowało przekroczenie dopuszczalnych parametrów.
...
Skrajne przeładowanie pojazdu zwykle kończy się nie tylko zakazem dalszej jazdy do czasu usunięcia naruszenia, ale też sankcjami administracyjnymi i finansowymi. W zależności od okoliczności konsekwencje mogą objąć zarówno kierowcę, jak i przedsiębiorcę odpowiedzialnego za organizację przewozu.

Sprawa zatrzymanego Iveco Daily jest kolejnym przykładem, że w transporcie dostawczym oszczędność na dodatkowym kursie może bardzo szybko zamienić się w poważny problem. Przy rosnącej liczbie kontroli drogowych i coraz większej świadomości dotyczącej bezpieczeństwa takie przypadki nadal pokazują, jak często lekceważone są podstawowe limity masowe pojazdów dostawczych. Dla użytkowników busów to jasny sygnał – ładowność nie jest wartością orientacyjną, lecz twardym ograniczeniem, którego przekroczenie może mieć poważne skutki.
