...
faq:
  ...
  - question: "Które busy najlepiej nadają się do zabudowy serwisowej?"
    answer: "Najpopularniejsze to Fiat Ducato L2H2, Ford Transit L3H2 i Mercedes Sprinter – oferują dużą przestrzeń ładunkową i szeroką ofertę dedykowanych systemów zabudów."
  - question: "Czy zabudowę serwisową można przenieść do nowego busa?"
    answer: "Tak, systemy modułowe (np. Sortimo Globelyst, Store Van) są projektowane z myślą o przenoszeniu. Demontaż i ponowny montaż trwa 4–8 godzin, a regały zachowują 40–60% wartości po 5 latach."
  - question: "Jakie normy musi spełniać zabudowa serwisowa?"
    answer: "Zabudowa powinna spełniać normę DIN EN 12195 dotyczącą zabezpieczenia ładunku oraz przechodzić crash-testy wg ECE R17. Certyfikowane systemy posiadają atesty TÜV."
---
...
{{% info title="Inwentaryzacja i system oznaczeń" icon="engineering" %}}Oznacz każde gniazdo etykietą lub kodem kolorystycznym – nowy pracownik od pierwszego dnia wie, gdzie co leży. Systemy Sortimo i Würth oferują dedykowane aplikacje do zarządzania inwentarzem narzędzi w busie.{{% /info %}}
...
W busach o niskim DMC (np. 2800 kg) aluminium jest jedyną sensowną opcją, ponieważ stalowa zabudowa o wadze 150–200 kg znacząco obcina użyteczną ładowność. W dużych busach typu [Mercedes Sprinter](/modele/mercedes-sprinter/) o DMC 3500 kg różnica jest mniej odczuwalna.
...
- **[Mercedes Sprinter](/modele/mercedes-sprinter/) 315 CDI i 317 CDI** – solidna konstrukcja, DMC do 3500 kg, premium wykończenie
