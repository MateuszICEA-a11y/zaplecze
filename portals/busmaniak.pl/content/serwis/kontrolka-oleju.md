...
faq:
  - question: "Czy mogę jechać z żółtą kontrolką oleju?"
    answer: "Tak, ale ostrożnie – żółta kontrolka sygnalizuje niski poziom oleju. Unikaj wysokich obrotów, nie bierz ostrych zakrętów (olej odchodzi od smoka pompy) i jak najszybciej dolej olej do prawidłowego poziomu."
  ...
  - question: "Ile oleju zużywa bus na 1000 km?"
    answer: "Normatywne zużycie oleju w busach dostawczych wynosi 0,3–0,5 l na 1000 km. Powyżej 0,8 l na 1000 km wskazuje na problem – zużyte uszczelki zaworów, pierścienie tłokowe lub turbinę."
...
1.  **Włącz światła awaryjne** – zasygnalizuj innym kierowcom, że będziesz się zatrzymywać
...
Prowadź dziennik zużycia oleju – przy każdym tankowaniu sprawdzaj i zapisuj poziom na bagnecie. Wzrost zużycia oleju o 50% w porównaniu do poprzednich miesięcy jest wczesnym sygnałem problemów mechanicznych. Pozwala to zaplanować naprawę, zanim kontrolka stanie się stałym gościem na desce rozdzielczej.
{{% /info %}}
