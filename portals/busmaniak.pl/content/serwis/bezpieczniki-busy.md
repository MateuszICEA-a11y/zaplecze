...
[Fiat Ducato](/modele/fiat-ducato/) ma kilka lokalizacji bezpieczników:

- **Skrzynka kabinowa** – po lewej stronie deski rozdzielczej, za klapką widoczną po otwarciu drzwi kierowcy. Chroni m.in. centralny zamek, radio, wycieraczki, oświetlenie wnętrza, klimatyzację, gniazda 12V.
- **Skrzynka silnikowa** – przy lewym nadkolu, pod plastikową pokrywą. Odpowiada za obwody pompy paliwa, świec żarowych, wentylatora chłodnicy, ABS, ESP i reflektorów.
- **Blok na akumulatorze** – bezpieczniki mega i linkowe, chroniące główne przewody zasilające (alternator, rozrusznik, linia B+).
- **Skrzynka w słupku B** – w wersjach pod zabudowę lub z fabrycznymi złączami konwertera występuje dodatkowa skrzynka (CPL) w prawym słupku B. Znajdują się tam bezpieczniki (15 A, 20 A) dla obwodów zabudowy, dodatkowego ogrzewania czy wyjścia PTO.
...
- **Skrzynka kabinowa** – w przestrzeni na nogi po stronie kierowcy (W906) lub po stronie kierowcy pod pokrywą z tworzywa (W907). Bezpieczniki mini i micro2 – elektronika kabiny, multimedia, oświetlenie.
