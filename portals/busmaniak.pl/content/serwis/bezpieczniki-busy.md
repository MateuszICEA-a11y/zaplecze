...
h1: "Bezpieczniki w busie – rodzaje, lokalizacja i typowe awarie"
type: "page"
volume: 1500
...
faq:
  - question: "Ile bezpieczników ma Fiat Ducato?"
    answer: "Fiat Ducato III (2006–2024) ma ok. 51 bezpieczników w dwóch głównych skrzynkach – 27 w kabinie (pod deską rozdzielczą po stronie kierowcy) i 24 w komorze silnika. Dodatkowo na akumulatorze znajduje się blok bezpieczników wysokoprądowych."
...
Najczęstszy typ w busach – cienkie, kolorowe wkładki z dwoma nóżkami. Występują w trzech rozmiarach:
...
W skrzynce silnikowej i na akumulatorze znajdziesz bezpieczniki większe niż płytkowe:
...
| :--- | :--- | :--- |
| **Szary** | 2 A | Sterownik ECU, immobilizer |
| **Fioletowy** | 3 A | Zegarek, podświetlenie zegara |
| **Różowy** | 4 A | Oświetlenie tablicy rejestracyjnej |
| **Brązowy (jasny)** | 5 A | Sygnalizacja, czujniki |
| **Brązowy** | 7,5 A | Radio, nawigacja, gniazdo USB |
| **Czerwony** | 10 A | Centralny zamek, lusterka |
| **Niebieski** | 15 A | Wycieraczki, gniazdo 12V |
| **Żółty** | 20 A | Podgrzewanie szyb, reflektory |
...
Busy dostawcze mają 2–3 skrzynki bezpieczników rozmieszczone w różnych częściach pojazdu. Każda skrzynka odpowiada za inne obwody – kabinowa za elektronikę wnętrza, silnikowa za podzespoły pod maską.

### Fiat Ducato III (2006–2024)

[Fiat Ducato](/modele/fiat-ducato/) ma trzy lokalizacje bezpieczników:

- **Skrzynka kabinowa** – po lewej stronie deski rozdzielczej, za klapką widoczną po otwarciu drzwi kierowcy. 27 bezpieczników mini – centralny zamek, radio, wycieraczki, oświetlenie wnętrza, klimatyzacja, gniazda 12V
- **Skrzynka silnikowa** – przy lewym nadkolu, pod plastikową pokrywą. 24 bezpieczniki – pompa paliwa, świece żarowe, wentylator chłodnicy, ABS, ESP, reflektory
- **Blok na akumulatorze** – bezpieczniki mega i linkowe, chroniące główne przewody zasilające (alternator, rozrusznik, linia B+)

Szczegółowy schemat z opisem każdego bezpiecznika znajdziesz w artykule [bezpieczniki Fiat Ducato](/serwis/bezpieczniki-fiat-ducato/). Jeśli szukasz przekaźników, sprawdź [przekaźniki Fiat Ducato](/serwis/przekazniki-fiat-ducato/).
...
- **Skrzynka kabinowa** – pod deską rozdzielczą po stronie pasażera (W906) lub po stronie kierowcy pod pokrywą z tworzywa (W907). Bezpieczniki mini i micro2 – elektronika kabiny, multimedia, oświetlenie
- **Skrzynka silnikowa** – obok akumulatora, pod dużą pokrywą. Bezpieczniki maxi i JCase – sterownik silnika, pompa paliwa, układ AdBlue, wentylatory

W Sprinterze W907 (od 2018) dodano trzecią skrzynkę pod siedzeniem kierowcy – zawiera bezpieczniki układów bezpieczeństwa (airbag, napinacze pasów).

### Ford Transit Mk8 (2014–2024)

Ford Transit ma dwie skrzynki:

- **Skrzynka kabinowa** – pod deską rozdzielczą po stronie pasażera, za schowkiem. Dostęp po wyjęciu schowka (dociśnij boki i pociągnij). 40+ bezpieczników mini
...
1. Włóż nowy bezpiecznik o **identycznym amperażu** (ten sam kolor)
2. Dociśnij go do oporu – nóżki muszą wejść całkowicie w gniazdo
3. Włącz urządzenie, które nie działało
4. Jeśli nowy bezpiecznik natychmiast się przepali – **nie wkładaj kolejnego**. Problem leży w obwodzie (zwarcie), nie w bezpieczniku
...
Busy dostawcze mają specyficzne problemy elektryczne wynikające z intensywnej eksploatacji, wibracji i narażenia na wilgoć. Poniżej najczęstsze awarie, które prowadzą do przepalania bezpieczników.

### Najczęstsze przyczyny przepalania bezpieczników

| Objaw | Bezpiecznik | Prawdopodobna przyczyna |
| :--- | :--- | :--- |
...
- **Zalanie skrzynki silnikowej** – w busach z niskim zawieszeniem (Ducato, Transit) skrzynka bezpieczników pod maską jest narażona na zalewanie podczas mycia silnika
- **Obciążenie dodatkowym osprzętem** – busy kamperowe i kurierskie mają doinstalowane lodówki, ogrzewanie postojowe, przetwornice 230V – obciążają fabryczną instalację ponad jej wydolność
...
## Bezpieczniki w konkretnych modelach – gdzie szukać szczegółów {#modele}
