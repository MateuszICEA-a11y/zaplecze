...
h1: "Bezpieczniki Peugeot Boxer – kompletny schemat i lokalizacja"
parent_model: "peugeot-boxer"
type: "post"
volume: 800
...
faq:
  - question: "Gdzie jest bezpiecznik od zapalniczki w Peugeocie Boxer?"
    answer: "W modelach od 2006 roku odpowiada za nią bezpiecznik F44 (10A lub 15A) w skrzynce pod deską rozdzielczą. W wersjach po 2014 roku lokalizacja jest taka sama, ale zawsze warto zweryfikować schemat na pokrywie skrzynki."
  - question: "Czy bezpieczniki z Fiata Ducato pasują do Boxera?"
...
{{% info title="Dostęp" icon="engineering" %}}
W komorze silnika skrzynka jest zabezpieczona zatrzaskami – nie śrubami. Podważ pokrywę płaskim narzędziem od strony bliższej reflektorowi. Wewnątrz pokrywy znajdziesz plastikowy chwytak do wyciągania bezpieczników. Nie używaj kombinerek, ponieważ mogą uszkodzić gniazda.
{{% /info %}}

## Schemat bezpieczników Boxer III (2006–2014)

Poniższe tabele prezentują najważniejsze obwody elektryczne. Pełny schemat (ponad 50 pozycji) znajduje się na naklejce wewnątrz pokrywy skrzynki lub w instrukcji obsługi pojazdu.
...
| F32 | Oświetlenie wnętrza | 10A |
| F33 | Dodatkowe gniazdo 12V | 15A |
| F36 | Złącze diagnostyczne OBD2 | 10A |
| F37 | Światła stop | 10A |
| F43 | Wycieraczki przednie | 25A |
| F44 | Zapalniczka | 15A |
| F49 | Panel sterowania, radio, pamięć zegarów | 7,5A |
| F51 | Tablica przyrządów (zegary) | 7,5A |
| F53 | Centralny zamek, sterowniki drzwi | 20A |

### Skrzynka w komorze silnika

| Nr | Funkcja | Amperaż |
| :--- | :--- | :--- |
| MF01 | Główne zasilanie (akumulator) | 60A |
| MF02 | Wentylator chłodnicy | 40A |
| MF03 | Pompa paliwa | 25A |
| MF05 | Sterownik silnika (ECU) | 30A |
| MF06 | Moduł ABS/ESP | 30A |
| MF07 | Układ poduszek powietrznych | 15A |
| MF08 | Wspomaganie kierownicy (EPS) | 40A |
| MF09 | Sprężarka klimatyzacji | 40A |
| MF11 | Rozrusznik | 50A |
...
Facelift z 2014 roku wprowadził zmiany w kilku obwodach. Najważniejsze różnice dotyczą systemów bezpieczeństwa i dodatkowych gniazd zasilania.
...
-   **Awaria BSI (Body System Interface)** – centralny moduł sterujący bezpiecznikami. Objawy: losowe wyłączanie obwodów, migoczące światła, brak reakcji na kluczyk. Naprawa wymaga wymiany lub programowania modułu.
-   **Bezpiecznik świec żarowych (MF13)** – przepala się najczęściej przy uszkodzeniu jednej ze świec. Przed wymianą bezpiecznika należy sprawdzić rezystancję wszystkich świec.
...
Procedura jest prosta, ale wymaga przestrzegania kilku zasad bezpieczeństwa, aby uniknąć zwarcia.

1.  Wyłącz zapłon i odłącz wszystkie odbiorniki prądu (radio, ładowarki, światła).
2.  Zlokalizuj odpowiednią skrzynkę, korzystając ze schematu.
3.  Zdejmij pokrywę – pod deską odkręć śruby, w komorze silnika podważ zatrzaski.
4.  Wyciągnij bezpiecznik za pomocą chwytaka z pokrywy skrzynki – nigdy nie używaj metalowych narzędzi.
5.  Sprawdź stan bezpiecznika. Przerwany drucik lub czarny nalot oznacza, że jest spalony.
