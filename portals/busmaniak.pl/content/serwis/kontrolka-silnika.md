...
Kontrolka silnika (MIL – Malfunction Indicator Lamp) to element systemu diagnostyki pokładowej EOBD/OBD-II, obecnego w większości busów dostawczych wyprodukowanych po 2007 roku (od normy Euro 4). Jej zadaniem jest informowanie kierowcy o nieprawidłowościach wykrytych przez sterownik silnika.

Sygnały z deski rozdzielczej należy interpretować następująco:

- **Żółta (pomarańczowa) kontrolka** – standardowy sygnał MIL. Sterownik wykrył odstępstwo od normy, ale silnik może pracować w trybie zastępczym. Można kontynuować jazdę z ograniczeniami, unikając gwałtownego przyspieszania i wysokich obrotów.
- **Żółta kontrolka + czerwona ikona STOP** – awaria krytyczna. Standardowa kontrolka MIL jest zawsze żółta. Jeśli jednak usterka zagraża silnikowi, obok niej zapala się czerwony napis STOP lub inna czerwona ikona ostrzegawcza, np. ciśnienia oleju. Należy natychmiast zjechać na pobocze i wyłączyć silnik.
- **Migająca żółta kontrolka** – wypadanie zapłonów (misfire), które grozi przegrzaniem i uszkodzeniem katalizatora. Trzeba natychmiast zredukować obroty i obciążenie silnika.

W busach dostawczych żółta kontrolka silnika zapala się statystycznie częściej niż w autach osobowych. Wynika to z intensywnej eksploatacji, wyższych przebiegów i większego obciążenia układu wydechowego.

## Najczęstsze przyczyny zapalenia kontrolki silnika {#przyczyny}

Sterownik silnika monitoruje dziesiątki parametrów – od składu spalin po ciśnienie doładowania. Przyczyny zapalenia kontrolki można podzielić na kilka głównych kategorii.
...
- **Czujnik MAP/MAF** – mierzy masę lub ciśnienie zasysanego powietrza. Zabrudzony czujnik MAF może powodować zawyżanie lub zaniżanie dawki paliwa.
- **Czujnik ciśnienia doładowania** – w busach z turbodoładowaniem błędny odczyt ciśnienia skutkuje ograniczeniem mocy silnika i przejściem w tryb awaryjny.
- **Czujnik temperatury spalin** – monitoruje temperaturę przed i za filtrem DPF. Usterka jednego z czujników blokuje procedurę regeneracji filtra.
...
| **Kontrolka silnika (piktogram)** | Fiat Ducato, Citroën Jumper, Peugeot Boxer |
...
Odpowiedź zależy od koloru kontrolki i zachowania silnika.
...
Każdy model busa ma swoje charakterystyczne słabe punkty, które najczęściej prowadzą do zapalenia kontrolki silnika.
...
- Czujnik różnicy ciśnień DPF – koroduje i daje błędne odczyty
...
W popularnym silniku 2.3 dCi, montowanym również w Oplu Movano, kontrolka MIL często sygnalizuje usterki typowe dla intensywnej eksploatacji kurierskiej:

- Usterki układu AdBlue, w tym awarie grzałki lub pompy ciśnienia
- Pęknięcia chłodnicy zaworu EGR prowadzące do wycieków płynu
- Awarie elektrozaworów sterujących pracą turbosprężarek (w wersjach Bi-Turbo) po przebiegu 200 000–250 000 km
...
- Czujnik NOx – kosztowna część (1 500–3 000 zł), kluczowa dla systemu SCR
- Sterownik skrzyni biegów 7G-Tronic – generuje kody błędów wpływające na pracę silnika
- Wtryskiwacze piezoelektryczne – nieszczelności po przebiegu powyżej 200 000 km

### Ford Transit

W Fordzie Transicie z silnikami EcoBlue 2.0:

- Układ EGR – podatny na nagromadzenie sadzy, co prowadzi do jego blokady
