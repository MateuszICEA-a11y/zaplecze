...
{{% info title="Kiedy wymienić rozrząd wcześniej" icon="engineering" %}}
Jeśli Twój bus pracuje jako kamper z pełnym obciążeniem (DMC 3,5 t) lub w trybie kurierskim z setkami rozruchów dziennie, skróć interwał wymiany paska o 20%. Guma starzeje się szybciej w warunkach wysokiej temperatury, a napinacze zużywają się od wibracji.
{{% /info %}}
...
1. **Układ hamulcowy** – skuteczność hamowania na rolkach, stan przewodów.
